...
|<BL18>|TERP + NO3 = 0.227*xHO2 + 0.287*xNO2 + 0.026*xRCO3 + 1.786*RO2C + 0.46*RO2XC + 0.46*zRNO3 + 0.012*xCO + 0.023*xHCHO + 0.002*xHOCCHO + 0.403*xRCHO + 0.239*xACETONE + 0.005*xMACR + 0.001*xMVK + 0.004*xIPRD + 0.228*xRNO3 + yR6OOH + TRPRXN + 0.485*XN + 3.785*XC|1.33e-12*exp<sup>(490/T)</sup>| | |
