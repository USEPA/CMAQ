...
#> Set General Parameters for Configuring the Simulation
 ...
 set EMIS      = 2016gf_16j            #> Emission Inventory Details
 set APPL      = saprc22_ebi_May2025_updates  #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 setenv OUTDIR  ${CMAQ_HOME}/data/CCTM_${RUNID} #> Output Directory
 setenv INPDIR  ${CMAQ_HOME}/data/input  #Input Directory
...
set ICpath    = $INPDIR/icbc_saprc22              #> initial conditions input directory
set BCpath    = $INPDIR/icbc_saprc22              #> boundary conditions input directory
set EMISpath  = $INPDIR/emis_saprc22/area/merged_nobeis_withrwc #> surface emissions input directory
set IN_PTpath = $INPDIR/emis                    #> elevated emissions input directory (in-line point only)
set IN_PTpath2 = $INPDIR/emis_saprc22/point
...
while ($TODAYJ <= $STOP_DAY )  #>Compare dates in terms of YYYYJJJ
  ...
  set MMDD = `date -ud "${TODAYG}" +%m%d`           #> Convert YYYY-MM-DD to MMDD
  set YYYYJJJ = $TODAYJ
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE ICON_2016fj_16j_cb6r3_ae7_aq_nvpoa.v532_m3dry.36US3to12US2_35_20160701.nc
  ...
  set BCFILE = BCON_12US2_SAPRC7AE7_2_SAPRC22AE7_${YYYYMMDD}.nc
  ...
  setenv GRID_BDY_2D $METpath/GRIDBDY2D.12US2.35L.$YYMMDD
  setenv GRID_CRO_2D $METpath/GRIDCRO2D.12US2.35L.$YYMMDD
  setenv GRID_CRO_3D $METpath/GRIDCRO3D.12US2.35L.$YYMMDD
  setenv GRID_DOT_2D $METpath/GRIDDOT2D.12US2.35L.$YYMMDD
  setenv MET_CRO_2D  $METpath/METCRO2D.12US2.35L.$YYMMDD
  setenv MET_CRO_3D  $METpath/METCRO3D.12US2.35L.$YYMMDD
  setenv MET_DOT_3D  $METpath/METDOT3D.12US2.35L.$YYMMDD
  setenv MET_BDY_3D  $METpath/METBDY3D.12US2.35L.$YYMMDD
  setenv LUFRAC_CRO  $METpath/LUFRAC_CRO.12US2.35L.$YYMMDD
  ...
  setenv DESID_CHEM_CTRL_NML ${BLD}/CMAQ_Control_DESID_${MECH}.nml ###received this control file from EPA (PV comment)
  ...
  setenv CMAQ_MASKS $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_12US2.nc  #> horizontal grid-dependent ocean file
  ...
  setenv N_EMIS_GR 1
  set EMISfile  = emis_12US2_nobeis_withrwc_2016gf_SAPRC7AE7_2_SAPRC22AE7_${YYYYMMDD}.nc
  ...
  set STKCASEE = 12US1_cmaq_cb6ae7_2016fm_16j        # In-line Emission Rate File Suffix
  set STKCASEG = 12US1_2016fm_16j                 # Stack parameter File Suffix

  set STKCASEE1 = 12US1_cmaq_cb6ae7_2016gf_16j        # In-line Emission Rate File Suffix
  set STKCASEG1 = 12US1_2016gf_16j

  setenv STK_GRPS_001 $IN_PTpath/ptnonipm/stack_groups_ptnonipm_${STKCASEG1}.ncf
  setenv STK_GRPS_002 $IN_PTpath/ptegu/stack_groups_ptegu_${STKCASEG1}.ncf
  setenv STK_GRPS_003 $IN_PTpath/pt_oilgas/stack_groups_pt_oilgas_${STKCASEG1}.ncf
  setenv STK_GRPS_004 $IN_PTpath/cmv_c3_12/stack_groups_cmv_c3_12_${STKCASEG}.ncf
  setenv STK_GRPS_005 $IN_PTpath/cmv_c1c2_12/stack_groups_cmv_c1c2_12_${STKCASEG}.ncf
  
  setenv STK_GRPS_006 $IN_PTpath/othpt/stack_groups_othpt_12US1_2016fj_16j.ncf
  setenv STK_GRPS_007 $IN_PTpath/ptagfire/stack_groups_ptagfire_2016${MMDD}_12US1_2016fj_16j.ncf
  setenv STK_GRPS_008 $IN_PTpath/ptfire_othna/stack_groups_ptfire_othna_2016${MMDD}_12US1_2016fj_16j.ncf
  setenv STK_GRPS_009 $IN_PTpath/ptfire-rx/stack_groups_ptfire-rx_2016${MMDD}_12US1_2016fj_16j.ncf
  setenv STK_GRPS_010 $IN_PTpath/ptfire-wild/stack_groups_ptfire-wild_2016${MMDD}_12US1_2016fj_16j.ncf


  setenv STK_EMIS_001 $IN_PTpath2/ptnonipm/inln_mole_ptnonipm_${mwdss_Y}_12US1_cmaq_saprc22ae7_2016gf_16j.ncf
  setenv STK_EMIS_002 $IN_PTpath2/ptegu/inln_mole_ptegu_${YYYYMMDD}_12US1_cmaq_saprc22ae7_2016gf_16j.ncf
  setenv STK_EMIS_003 $IN_PTpath2/pt_oilgas/inln_mole_pt_oilgas_${mwdss_Y}_12US1_cmaq_saprc22ae7_2016gf_16j.ncf
  setenv STK_EMIS_004 $IN_PTpath2/cmv_c3_12/inln_mole_cmv_c3_12_${YYYYMMDD}_12US1_cmaq_saprc22ae7_2016fm_16j.ncf
  setenv STK_EMIS_005 $IN_PTpath2/cmv_c1c2_12/inln_mole_cmv_c1c2_12_${YYYYMMDD}_12US1_cmaq_saprc22ae7_2016fm_16j.ncf

  setenv STK_EMIS_006 $IN_PTpath2/othpt/inln_mole_othpt_${mwdss_N}_12US1_cmaq_saprc22ae7_2016fj_16j.ncf
  setenv STK_EMIS_007 $IN_PTpath2/ptagfire/inln_mole_ptagfire_2016${MMDD}_12US1_cmaq_saprc22ae7_2016fj_16j.ncf
  setenv STK_EMIS_008 $IN_PTpath2/ptfire_othna/inln_mole_ptfire_othna_2016${MMDD}_12US1_cmaq_saprc22ae7_2016fj_16j.ncf
  setenv STK_EMIS_009 $IN_PTpath2/ptfire-rx/inln_mole_ptfire-rx_2016${MMDD}_12US1_cmaq_saprc22ae7_2016fj_16j.ncf
  setenv STK_EMIS_010 $IN_PTpath2/ptfire-wild/inln_mole_ptfire-wild_2016${MMDD}_12US1_cmaq_saprc22ae7_2016fj_16j.ncf
  ...
  setenv STK_EMIS_LAB_005 PT_CMV_C1C2
  setenv STK_EMIS_LAB_006 PT_OTH
  setenv STK_EMIS_LAB_007 PT_FIRE_AG
  setenv STK_EMIS_LAB_008 PT_FIRE_OTHNA
  setenv STK_EMIS_LAB_009 PT_FIRE_RX
  setenv STK_EMIS_LAB_010 PT_FIRE_WILD
  ...
  if ( $CTM_BIOGEMIS_BE == 'Y' ) then   
     set IN_BEISpath = ${INPDIR}/beis_inline
     setenv GSPRO          ${BLD}/gspro_biogenics.txt
     setenv BEIS_NORM_EMIS $IN_BEISpath/beis_norm_emis_12US2_2016gf_16j.ncf
  ...
  setenv OCEAN_1 $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_12US2.nc

  #> Bidirectional ammonia configuration
  if ( $CTM_ABFLUX == 'Y' ) then
     # need to modify for FEST-C v1.4.
     setenv E2C_SOIL ${EPICpath}/us2_2016_cmaq12km_soil.nc
     setenv E2C_CHEM ${EPICpath}/us2_2016_cmaq12km_time$YYYYMMDD.nc
     setenv E2C_LU ${EPICpath}/beld4_CMAQ12km_2011.ncf
  endif
...
#      setenv ISAM_REGIONS RGN_ISAM.nc
...
######cgwilson  ( /usr/bin/time -p /usr/local/mpich-3.0.4.pgf_v13.4/bin/mpirun -np $NPROCS $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
