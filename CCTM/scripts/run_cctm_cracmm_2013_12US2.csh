...
#SBATCH -t 00:10:00
#SBATCH -n 128
#SBATCH -J CMAQ_cracmm
#SBATCH -p ord
#SBATCH --gid=mod3dev
#SBATCH -A mod3dev
#SBATCH -o /work/MOD3DEV/has/2021cracmm/cmaq/20210910cmaqproj/CCTM/scripts/2013_cracmm_%j.txt
...
#> Set General Parameters for Configuring the Simulation
 ...
 set EMIS      = 2013            #> Emission Inventory Details
 set APPL      = 2013_12US2      #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 setenv INPDIR  /work/MOD3DEV/fsidi/temp/sgq/RACM2_testbed  #Input Directory
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2013-05-01"     #> beginning date (January 1, 2016)
 set END_DATE   = "2013-05-01"     #> ending date    (December 31, 2016)
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE ICON_HEMI_CMAQv53_12US2_RACM2_regrid_20130501.nc 
...
# set BCFILE = bctr_12km_HCMAQ_V53BETA2_STAGE_cb6r3m_ae7_kmtbr_BCON_V53_${YYYYMM}.ncf
  set BCFILE = BCON_HEMI_CMAQv53_12US2_RACM2_regrid_${YYYYMMDD}.nc 
...
# setenv LUFRAC_CRO  $METpath/LUFRAC_CRO.$GRID_NAME.${NZ}L.$YYMMDD
  ...
  setenv CMAQ_MASKS $SZpath/12US2_surf.ncf

  #> Gridded Emissions files
  setenv N_EMIS_GR 1
  set EMISfile  = emis_mole_all_${YYYYMMDD}_12US2_cmaq_racm2e51_WR103_2013ej_r.ncf
  ...
  if ( $CTM_BIOGEMIS_BEIS == 'Y' ) then   
     ...
     setenv B3GRD      $IN_BEISpath/b3grd.smoke30_beis361.12US2.2011NLCD_FIA5.1_CDL_norm_v3.ncf
     setenv BIOSW_YN   Y     #> use frost date switch [ default: Y ]
     setenv BIOSEASON  $IN_BEISpath/bioseason.cmaq.2013j_12US2.ncf_full #> ignore season switch file if BIOSW_YN = N
  ...
  setenv OCEAN_1 $SZpath/12US2_surf.ncf
