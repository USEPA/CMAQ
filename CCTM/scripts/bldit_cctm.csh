...
#> The BLDMAKE utility will insert the compiler path into the Makefile
#> from the module-loaded environment. BLDMAKE reads the cfg.* file
#> generated by this bldit script and inserts the compiler into the
#> generated Makefile. Those compiler options are set in config.cmaq.
