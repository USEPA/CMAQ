...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2018_1NC1         #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 setenv INPDIR  /work/MOD3DATA/2018_1NC1  #Input Directory
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2018-01-01"     #> beginning date (December 22, 2017)
...
setenv GRID_NAME 1NC1     #> check GRIDDESC file for GRID_NAME options
...
set EMISpath  = $INPDIR/emis/cb6r3_ae6_20190605/cmaq_ready/gridded #> surface emissions input directory
set IN_PTpath = /work/MOD3DATA/2018_4EUS1/emis/cb6r3_ae6_20190605/cmaq_ready  #> elevated emissions input directory (in-line point only)
set IN_LTpath = $INPDIR/met/lightning     #> lightning NOx input directory
set METpath   = $INPDIR/met/WRFv4.1.1_MCIPv5.0              #> meteorology input directory
...
while ($TODAYJ <= $STOP_DAY )  #>Compare dates in terms of YYYYJJJ
  ...
  set MM       = `date -ud "${TODAYG}" +%m`     #> Convert YYYY-MM-DD to YYMMDD
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE CCTM_CGRID_v53_intel18.0_2018_1NC1_${YESTERDAY}.nc
  ...
  set BCFILE = BCON_v53_2018_1NC1_regrid_${YYYYMMDD}
  ...
  setenv LUFRAC_CRO  $METpath/LUFRAC_CRO.$GRID_NAME.${NZ}L.2018.Tindependent
  ...
  #>
  setenv EMISSCTRL_NML ${BLD}/EmissCtrl/EmissCtrl_cb6r3_ae7_aq_CarbAcid_${YYYYMMDD}.nml #${BLD}/EmissCtrl_${MECH}.nml

  #> Spatial Masks For Emissions Scaling
  #setenv CMAQ_MASKS $SZpath/12US1_surf.ncf

  #> Determine Representative Emission Days
  set EMDATES = $INPDIR/emis/emis_dates/smk_merge_dates_2018${MM}.txt
  set intable = `grep "^2018${MMDD}" $EMDATES`
  set thisDate = `echo $intable[1] | cut -d, -f1`
  ...
  setenv N_EMIS_GR 1
  set EMISfile  = emis_mole_all_${thisDate}_1NC1_nobeis_2018ff_18j.ncf
  setenv GR_EMIS_001 ${EMISpath}/${EMISfile}
  setenv GR_EMIS_LAB_001 GRIDDED_EMIS

  #set EMISfile  = emis_mole_rwc_${thisDate}_12US1_cmaq_cb6_2016ff_16j.ncf
  #setenv GR_EMIS_002 ${EMISpath2}/${EMISfile}
  #setenv GR_EMIS_LAB_002 GRIDDED_RWC
 
  #> In-Line Point Emissions Files
  setenv N_EMIS_PT 13          #> Number of elevated source groups

  set STKCASEE = 12US1_cmaq_cb6_2018ff_18j  # In-line Emission Rate File Suffix
  set STKCASEG = 12US1_2018ff_18j                 # Stack parameter File Suffix
  set STKCASEE4k = 4EUS1_cmaq_cb6_2018ff_18j  # In-line Emission Rate File Suffix
  set STKCASEG4k = 4EUS1_2018ff_18j                 # Stack parameter File Suffix

  setenv STK_GRPS_001 $IN_PTpath/ptnonipm_nopfas/stack_groups_ptnonipm_nopfas_${STKCASEG4k}.ncf
  ...
  setenv STK_GRPS_004 $IN_PTpath/ptagfire/stack_groups_ptagfire_${thisDate}_${STKCASEG}.ncf
  setenv STK_GRPS_005 $IN_PTpath/ptfire/stack_groups_ptfire_${thisDate}_${STKCASEG}.ncf
  setenv STK_GRPS_006 $IN_PTpath/ptfire_othna/stack_groups_ptfire_othna_${thisDate}_${STKCASEG}.ncf
  setenv STK_GRPS_007 $IN_PTpath/pt_oilgas/stack_groups_pt_oilgas_${STKCASEG4k}.ncf
  setenv STK_GRPS_008 $IN_PTpath/cmv_c3/stack_groups_cmv_c3_${STKCASEG}.ncf
  setenv STK_GRPS_009 $IN_PTpath/ptnonipm_pfas_chemoursnc/stack_groups_ptnonipm_pfas_chemoursnc_${STKCASEG4k}.ncf
  setenv STK_GRPS_010 $IN_PTpath/ptnonipm_pfas_chemoursother/stack_groups_ptnonipm_pfas_chemoursother_${STKCASEG4k}.ncf
  setenv STK_GRPS_011 $IN_PTpath/ptnonipm_pfas_dupont/stack_groups_ptnonipm_pfas_dupont_${STKCASEG4k}.ncf
  setenv STK_GRPS_012 $IN_PTpath/ptnonipm_pfas_stgobain/stack_groups_ptnonipm_pfas_stgobain_${STKCASEG4k}.ncf
  setenv STK_GRPS_013 $IN_PTpath/ptnonipm_pfas_other/stack_groups_ptnonipm_pfas_other_${STKCASEG4k}.ncf
  setenv LAYP_STTIME $STTIME
  setenv LAYP_NSTEPS $NSTEPS

  setenv STK_EMIS_001 $IN_PTpath/ptnonipm_nopfas/inln_mole_ptnonipm_nopfas_${mwdss_Y}_${STKCASEE4k}.ncf
  setenv STK_EMIS_002 $IN_PTpath/ptegu/inln_mole_ptegu_${thisDate}_${STKCASEE}.ncf
  setenv STK_EMIS_003 $IN_PTpath/othpt/inln_mole_othpt_${mwdss_N}_${STKCASEE}.ncf
  setenv STK_EMIS_004 $IN_PTpath/ptagfire/inln_mole_ptagfire_${thisDate}_${STKCASEE}.ncf
  setenv STK_EMIS_005 $IN_PTpath/ptfire/inln_mole_ptfire_${thisDate}_${STKCASEE}.ncf
  setenv STK_EMIS_006 $IN_PTpath/ptfire_othna/inln_mole_ptfire_othna_${thisDate}_${STKCASEE}.ncf
  setenv STK_EMIS_007 $IN_PTpath/pt_oilgas/inln_mole_pt_oilgas_${mwdss_Y}_${STKCASEE4k}.ncf
  setenv STK_EMIS_008 $IN_PTpath/cmv_c3/inln_mole_cmv_c3_${aveday_N}_${STKCASEE}.ncf
  setenv STK_EMIS_009 $IN_PTpath/ptnonipm_pfas_chemoursnc/inln_mole_ptnonipm_pfas_chemoursnc_${mwdss_Y}_${STKCASEE4k}.ncf
  setenv STK_EMIS_010 $IN_PTpath/ptnonipm_pfas_chemoursother/inln_mole_ptnonipm_pfas_chemoursother_${mwdss_Y}_${STKCASEE4k}.ncf
  setenv STK_EMIS_011 $IN_PTpath/ptnonipm_pfas_dupont/inln_mole_ptnonipm_pfas_dupont_${mwdss_Y}_${STKCASEE4k}.ncf
  setenv STK_EMIS_012 $IN_PTpath/ptnonipm_pfas_stgobain/inln_mole_ptnonipm_pfas_stgobain_${mwdss_Y}_${STKCASEE4k}.ncf
  setenv STK_EMIS_013 $IN_PTpath/ptnonipm_pfas_other/inln_mole_ptnonipm_pfas_other_${mwdss_Y}_${STKCASEE4k}.ncf
  ...
  setenv STK_EMIS_LAB_009 PT_PFAS_CHEMOURSNC
  setenv STK_EMIS_LAB_010 PT_PFAS_CHEMOURSOTHER
  setenv STK_EMIS_LAB_011 PT_PFAS_DUPONT
  setenv STK_EMIS_LAB_012 PT_PFAS_STGOBAIN
  setenv STK_EMIS_LAB_013 PT_PFAS_OTHER

  setenv STK_EMIS_DIAG_009 2DSUM
  setenv STK_EMIS_DIAG_010 2DSUM
  setenv STK_EMIS_DIAG_011 2DSUM
  setenv STK_EMIS_DIAG_012 2DSUM
  setenv STK_EMIS_DIAG_013 2DSUM
  ...
  if ( $CTM_BIOGEMIS == 'Y' ) then   
     ...
     setenv B3GRD      $IN_BEISpath/b3grd_1NC1.ncf
     setenv BIOSW_YN   Y     #> use frost date switch [ default: Y ]
     setenv BIOSEASON  $IN_BEISpath/bioseason.cmaq.2018_1NC1_out.ncf #updated for paper run, 1 May 2020
  ...
  if ( $CTM_WB_DUST == 'Y' ) then
     ...
     setenv DUST_LU_2 $LUpath/beld41_feb2017_1NC1_output.ncf
  endif
  
  #> In-line sea spray emissions configuration
  setenv OCEAN_1 $SZpath/ocean_file_1NC1.nc
  ...
  if ( $CTM_ABFLUX == 'Y' ) then
     ...
     setenv E2C_LU ${INPDIR}/surface/beld41_feb2017_1NC1_output.ncf
  endif
