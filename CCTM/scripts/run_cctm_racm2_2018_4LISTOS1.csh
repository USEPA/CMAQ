...
#SBATCH -t 168:00:00
#SBATCH -n 256
#SBATCH -J 4LISTOS1_RACM2
#SBATCH -p ord
#SBATCH --gid=mod3dev
#SBATCH -A mod3dev
#SBATCH -o /work/MOD3DEV/has/2021cracmm/cmaq/YYYYMMDDsim/CCTM/scripts/log_2018_4LISTOS1_%j.txt
...
#> Set General Parameters for Configuring the Simulation
 ...
 set MECH      = racm2_ae6_aq      #> Mechanism ID
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE ICON_v532_LISTOS4_racm2_20180502.ncf
  ...
  #> Boundary conditions
  set BCFILE = BCON_v532_LISTOS4_racm2_${YYYYMMDD}.ncf
  ...
  #> Emissions - EmissCtrl is set to use cracmmv0.21 in racm2
  set STKCASEG = 4LISTOS1_2018ff_18j_WR616          # Stack Group Version Label
  set STKCASEET = 4LISTOS1_cmaq_cracmmv0_21_2018ff_18j_WR616          # Emission Version Label
  ...
  setenv GR_EMIS_005 ${EMISpath}/cmaq_ready_area/np_solvents/emis_mole_np_solvents_${YYYYMMDD}_${STKCASEET}.ncf

  #> Gridden emission labels
  setenv GR_EMIS_LAB_001 GRIDDED_US_AIRCRAFT
  setenv GR_EMIS_LAB_002 GRIDDED_DIESEL
  setenv GR_EMIS_LAB_003 GRIDDED_GASOLINE
  setenv GR_EMIS_LAB_004 GRIDDED_OTHER
  ...
  setenv N_EMIS_PT 6          #> Number of elevated source groups
  # Time-Independent Stack Parameters for Inline Point Sources
  setenv STK_GRPS_001 $IN_PTpath/airports_can/stack_groups_airports_can_${STKCASEG}.ncf
  setenv STK_GRPS_002 $IN_PTpath/all_fire/stack_groups_all_fire_${YYYYMMDD}_${STKCASEG}.ncf
  setenv STK_GRPS_003 $IN_PTpath/cmv_4/stack_groups_cmv_4_${STKCASEG}.ncf
  setenv STK_GRPS_004 $IN_PTpath/othpt_solv/stack_groups_othpt_solv_${STKCASEG}.ncf
  setenv STK_GRPS_005 $IN_PTpath/pt_other_nonfire/stack_groups_pt_other_nonfire_${STKCASEG}.ncf
  setenv STK_GRPS_006 $IN_PTpath/pt_solvents/stack_groups_pt_solvents_${STKCASEG}.ncf
  ...
  setenv STK_EMIS_006 $IN_PTpath/pt_solvents/inln_mole_pt_solvents_${mwdss_Y}_${STKCASEET}.ncf
  setenv LAYP_STDATE $YYYYJJJ

  # Label Each Emissions Stream
  setenv STK_EMIS_LAB_001 PT_CANADA_AIRPORTS
  setenv STK_EMIS_LAB_002 PT_FIRE
  setenv STK_EMIS_LAB_003 PT_CMV
  setenv STK_EMIS_LAB_004 PT_CANADA_SOLVENTS
  setenv STK_EMIS_LAB_005 PT_OTHER
  setenv STK_EMIS_LAB_006 PT_US_SOLVENTS # duplicative with VCPy
