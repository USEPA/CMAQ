...
#  setenv LUFRAC_CRO $METpath/LUFRAC_CRO_${YYMMDD}
  ...
  if ( $CTM_BIOGEMIS_BE == 'Y' ) then   
     ...
     setenv BEIS_NORM_EMIS $IN_BEISpath/b3grd.smoke30_beis361.12US1.2011_BELD4.1_foliage_biomass_species_new_em3.ncf
     setenv BEIS_SOILINP        $OUTDIR/CCTM_SOILOUT_${RUNID}_${YESTERDAY}.nc
                             #> Biogenic NO soil input file; ignore if NEW_START = TRUE
  endif

  #> In-line sea spray emissions configuration
  setenv OCEAN_1 $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_12US1.nc #> horizontal grid-dependent ocean file file
