...
#> Set Working, Input, and Output Directories
 ...
 setenv INPDIR  ${CMAQ_DATA}/2014_12US1  #Input Directory
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2014-06-20"     #> beginning date (June 21, 2014)
...
set EMISpath  = $INPDIR/emis/cb6r3_ae6_20180115/cmaq_ready/gridded #> surface emissions input directory
set IN_PTpath = $INPDIR/emis/cb6r3_ae6_20180115/cmaq_ready   #> elevated emissions input directory (in-line point only)
...
# =====================================================================
  ...
  if ( $CTM_WB_DUST == 'Y' ) then
     ...
     setenv MODIS_FPAR $LUpath/modis_fpar_lai_12km_10yrAvg_daily_ioapi.ncf

     if ( $CTM_ERODE_AGLAND == 'Y' ) then
        setenv CROPMAP01 ${LUpath}/BeginPlanting_12km.ncf
        setenv CROPMAP04 ${LUpath}/EndPlanting_12km.ncf
        setenv CROPMAP08 ${LUpath}/EndHarvesting_12km.ncf
     endif
  endif
