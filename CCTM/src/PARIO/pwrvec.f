...
C $Header: /project/work/rep/PARIO/src/pwrvec.f,v 1.11 2017/11/29 20:14:28 bhh Exp $

      LOGICAL FUNCTION PWRVEC( FILNAME, VARNAME, DATE, TIME, BUFFER,
...
C Initialize return value and error code
      ...
      IF ( MY_PE .EQ. IO_PE ) THEN    ! I/O processor collects and writes data
         WSIZE = NVERTEXT * NLAYS3D
         RSIZE = NVERTEXT * NLAYS3D
...
C the I/O processor.
     ...
     &                  MPI_COMM_WORLD, IERROR )
         ...
         CALL MPI_SEND( WRITTBUF, MSGSIZE, MPI_REAL, IO_PE, TAG2,
     &                  MPI_COMM_WORLD, IERROR )
