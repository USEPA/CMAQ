...
!  Reaction Label T04             
                RKI( NCELL,  317) =  RJBLK( NCELL, IJ_FORM_R_IUPAC10 )
!  Reaction Label T05             
                RKI( NCELL,  318) =  RJBLK( NCELL, IJ_FORM_M_IUPAC10 )
!  Reaction Label T09             
                RKI( NCELL,  323) =  RJBLK( NCELL, IJ_ALD2_R_IUPAC10 )
!  Reaction Label T16             
...
!  Reaction Label OLIG_PAH1       
             RKI( NCELL,  299) =   9.4882D-06 * SFACT 
!  Reaction Label OLIG_PAH2       
             RKI( NCELL,  300) =   9.4882D-06 * SFACT 
!  Reaction Label OLIG_ALK1       
             RKI( NCELL,  301) =   9.4882D-06 * SFACT 
!  Reaction Label OLIG_ALK2       
             RKI( NCELL,  302) =   9.4882D-06 * SFACT 
