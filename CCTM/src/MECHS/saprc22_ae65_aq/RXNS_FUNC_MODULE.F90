...
!  Reaction Label TR01            
                RKI( NCELL,  793) =  RJBLK( NCELL, IJ_HCHOR_13 )
!  Reaction Label TR02            
                RKI( NCELL,  794) =  RJBLK( NCELL, IJ_HCHOM_13 )
!  Reaction Label TR08            
                RKI( NCELL,  798) =  RJBLK( NCELL, IJ_CCHOR_13 )
!  Reaction Label TR15            
                RKI( NCELL,  803) =  RJBLK( NCELL, IJ_ACROL_16 )
...
!  Reaction Label OLIG_AROMATIC2  
             RKI( NCELL,  774) =   9.4882D-06 * SFACT 
!  Reaction Label OLIG_AROMATIC3  
             RKI( NCELL,  775) =   9.4882D-06 * SFACT 
!  Reaction Label RPOAGEPI        
             RKI( NCELL,  776) =   2.5000D-12 * CFACT 
!  Reaction Label RPOAGELI        
             RKI( NCELL,  777) =  BLKHET(  NCELL, IK_HETERO_PNCOMLI )
!  Reaction Label RPOAGEPJ        
             RKI( NCELL,  778) =   2.5000D-12 * CFACT 
!  Reaction Label RPOAGELJ        
             RKI( NCELL,  779) =  BLKHET(  NCELL, IK_HETERO_PNCOMLJ )
!  Reaction Label PCSOA           
             RKI( NCELL,  780) =   1.2500D-11 * CFACT 
...
!  Reaction Label POA_AGE9        
             RKI( NCELL,  789) =   4.0000D-11 * CFACT 
!  Reaction Label POA_AGE10       
             RKI( NCELL,  790) =   4.0000D-11 * CFACT 
!  Reaction Label HET_GLY         
             RKI( NCELL,  791) =  BLKHET(  NCELL, IK_HETERO_GLY )
!  Reaction Label HET_MGLY        
             RKI( NCELL,  792) =  BLKHET(  NCELL, IK_HETERO_MGLY )
!  Reaction Label TR03            
             RKI( NCELL,  795) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.5000D-12,   1.2500D+02 )
!  Reaction Label TR05            
             RKI( NCELL,  796) =   5.8000D-16 * CFACT 
!  Reaction Label TR07            
             RKI( NCELL,  797) =  CFACT * ARRHENUIS_T04( INV_TEMP,  TEMPOT300, & 
     &                                                   2.4000D-12,   5.4600D+02,   7.7000D-01 )
!  Reaction Label TR09            
             RKI( NCELL,  799) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-12,  -1.8600D+03 )
!  Reaction Label TR11            
             RKI( NCELL,  800) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.1000D-12,   3.3300D+02 )
!  Reaction Label TR12            
             RKI( NCELL,  801) =   2.8000D-19 * CFACT 
!  Reaction Label TR13            
             RKI( NCELL,  802) =   1.1000D-15 * CFACT 
