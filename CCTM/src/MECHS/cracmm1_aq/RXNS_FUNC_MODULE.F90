...
!  Reaction Label HAL_Ozone       
                   RKI( NCELL,  389) =  SFACT * HALOGEN_FALLOFF( BLKPRES( NCELL ),   6.7006D-11,   1.0743D+01,  & 
...
!  Reaction Label R003c           
             RKI( NCELL,  383) =   3.5000D-11 * CFACT 
!  Reaction Label R004c           
             RKI( NCELL,  384) =   1.2000D-11 * CFACT 
!  Reaction Label HET_GLY         
             RKI( NCELL,  385) =  BLKHET(  NCELL, IK_HETERO_GLY )
!  Reaction Label HET_MGLY        
             RKI( NCELL,  386) =  BLKHET(  NCELL, IK_HETERO_MGLY )
!  Reaction Label HET_N2O5        
             RKI( NCELL,  387) =  BLKHET(  NCELL, IK_HETERO_N2O5IJ )
!  Reaction Label HET_N02         
             RKI( NCELL,  388) =  BLKHET(  NCELL, IK_HETERO_NO2 )
!  Reaction Label HET_IEPOX       
             RKI( NCELL,  390) =  BLKHET(  NCELL, IK_HETERO_IEPOX )
...
!  Reaction Label RPOAGEPI        
             RKI( NCELL,  406) =   2.5000D-12 * CFACT 
!  Reaction Label RPOAGELI        
             RKI( NCELL,  407) =  BLKHET(  NCELL, IK_HETERO_PNCOMLI )
!  Reaction Label RPOAGEPJ        
             RKI( NCELL,  408) =   2.5000D-12 * CFACT 
!  Reaction Label RPOAGELJ        
             RKI( NCELL,  409) =  BLKHET(  NCELL, IK_HETERO_PNCOMLJ )
!  Reaction Label PCSOA           
             RKI( NCELL,  410) =   1.2500D-11 * CFACT 
!  Reaction Label POA_AGE1        
             RKI( NCELL,  411) =   4.0000D-11 * CFACT 
!  Reaction Label POA_AGE2        
             RKI( NCELL,  412) =   4.0000D-11 * CFACT 
!  Reaction Label POA_AGE3        
             RKI( NCELL,  413) =   4.0000D-11 * CFACT 
!  Reaction Label POA_AGE4        
             RKI( NCELL,  414) =   4.0000D-11 * CFACT 
!  Reaction Label POA_AGE5        
             RKI( NCELL,  415) =   4.0000D-11 * CFACT 
