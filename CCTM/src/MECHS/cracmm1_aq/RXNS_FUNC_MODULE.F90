...
!  Reaction Label R027c           
                RKI( NCELL,   32) =  RJBLK( NCELL, IJ_BALD3_CALVERT11 )
!  Reaction Label R028            
...
!  Reaction Label R029a           
                RKI( NCELL,   36) =  RJBLK( NCELL, IJ_OP1_RACM2 )
!  Reaction Label R030            
                RKI( NCELL,   37) =  RJBLK( NCELL, IJ_PAA_RACM2 )
!  Reaction Label R031            
                RKI( NCELL,   38) =  RJBLK( NCELL, IJ_ONIT_CALVERT08 )
!  Reaction Label R032            
                RKI( NCELL,   39) =  RJBLK( NCELL, IJ_PAN1_JPL19 )
!  Reaction Label R033            
                RKI( NCELL,   40) =  RJBLK( NCELL, IJ_PAN2_JPL19 )
!  Reaction Label R033a           
                RKI( NCELL,   41) =  RJBLK( NCELL, IJ_PPN1_JPL19 )
!  Reaction Label R033b           
                RKI( NCELL,   42) =  RJBLK( NCELL, IJ_PPN2_JPL19 )
!  Reaction Label T20             
                RKI( NCELL,  390) =  RJBLK( NCELL, IJ_ACRO_09 )

                IF ( SEAWATER (NCELL) .GT. 0.001D0 ) THEN
!  Reaction Label HAL_Ozone       
                   RKI( NCELL,  419) = SEAWATER (NCELL) *  SFACT * HALOGEN_FALLOFF( BLKPRES( NCELL ),   6.7006D-11,   1.0743D+01,  & 
...
!  Reaction Label R034            
             RKI( NCELL,   43) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-12,  -9.4000D+02 )
!  Reaction Label R035            
             RKI( NCELL,   44) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0000D-14,  -4.9000D+02 )
!  Reaction Label R036            
             RKI( NCELL,   45) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.0000D-12,  -1.5000D+03 )
!  Reaction Label R037            
             RKI( NCELL,   46) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-13,  -2.4500D+03 )
!  Reaction Label R038            
             RKI( NCELL,   47) =  CFACT_SQU * POWER_T02( TEMPOT300,   6.1000D-34,  -2.4000D+00 )
!  Reaction Label R039            
             RKI( NCELL,   48) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.0000D-12,  -2.0600D+03 )
!  Reaction Label R040            
             RKI( NCELL,   49) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.3000D-11,   5.5000D+01 )
!  Reaction Label R041            
             RKI( NCELL,   50) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.1500D-11,   1.1000D+02 )
!  Reaction Label R042            
             RKI( NCELL,   51) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6300D-10,   6.0000D+01 )
!  Reaction Label R043            
             RKI( NCELL,   52) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-12,  -1.8000D+03 )
!  Reaction Label R044            
             RKI( NCELL,   53) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.8000D-11,   2.5000D+02 )
!  Reaction Label R045            
             RKI( NCELL,   54) =  CFACT * FALLOFF_T09( INV_TEMP,  CAIR, & 
     &                                                 3.0000D-13,   4.6000D+02,   2.1000D-33,  & 
     &                                                 9.2000D+02 )
!  Reaction Label R046            
             RKI( NCELL,   55) =  CFACT_SQU * FALLOFF_T09( INV_TEMP,  CAIR, & 
     &                                                 4.2000D-34,   2.6600D+03,   2.9400D-54,  & 
     &                                                 3.1200D+03 )
!  Reaction Label R047            
             RKI( NCELL,   56) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8000D-12,   0.0000D+00 )
!  Reaction Label R048            
...
!  Reaction Label R049            
     ...
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R050            
             RKI( NCELL,   59) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4400D-12,   2.6000D+02 )
!  Reaction Label R051            
             RKI( NCELL,   60) =  CFACT * FALLOFF_T11( INV_TEMP,TEMPOT300,CAIR, & 
     &                                                 6.0950D-14,  -1.0000D+00,   2.7000D+02, &
     &                                                 6.8570D-34,   1.0000D+00,   2.7000D+02,  & 
     &                                                -5.9680D-14,   2.7000D+02 )
!  Reaction Label R052            
             RKI( NCELL,   61) =  CFACT_SQU * ARRHENUIS_T03( INV_TEMP,  4.2500D-39,   6.6350D+02 )
!  Reaction Label R053            
             RKI( NCELL,   62) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.0000D-12,   2.5000D+02 )
!  Reaction Label R054            
             RKI( NCELL,   63) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.3000D-12,   2.0000D+02 )
!  Reaction Label R055            
...
!  Reaction Label R056            
     ...
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R057            
             RKI( NCELL,   66) =  CFACT * FALLOFF_T08( INV_TEMP,  CAIR, & 
     &                                                 2.4000D-14,   4.6000D+02,   2.7000D-17,  & 
     &                                                 2.1990D+03,   6.5000D-34,   1.3350D+03 )
!  Reaction Label R058            
             RKI( NCELL,   67) =   2.0000D-11 * CFACT 
!  Reaction Label R059            
             RKI( NCELL,   68) =   3.5000D-12 * CFACT 
!  Reaction Label R060            
             RKI( NCELL,   69) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-11,   1.2500D+02 )
!  Reaction Label R061            
             RKI( NCELL,   70) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.3500D-14,  -1.3350D+03 )
!  Reaction Label R062            
             RKI( NCELL,   71) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.5000D-13,  -2.4500D+03 )
!  Reaction Label R063            
             RKI( NCELL,   72) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 2.4000D-30,   0.0000D+00,  -3.0000D+00,  & 
     &                                                 1.6000D-12,   0.0000D+00,   1.0000D-01,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R064            
             RKI( NCELL,   73) =  RFACT * RKI( NCELL,   72 ) & 
     &                         * (  1.7241D+26 * DEXP( -1.0840D+04 * INV_TEMP) ) 
!  Reaction Label R065            
             RKI( NCELL,   74) =   1.0000D-22 * CFACT 
!  Reaction Label R066            
             RKI( NCELL,   75) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 1.9000D-31,   0.0000D+00,  -3.4000D+00,  & 
     &                                                 4.0000D-12,   0.0000D+00,  -3.0000D-01,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R067            
             RKI( NCELL,   76) =  RFACT * RKI( NCELL,   75 ) & 
     &                         * (  4.7619D+26 * DEXP( -1.0900D+04 * INV_TEMP) ) 
!  Reaction Label R068            
             RKI( NCELL,   77) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.5000D-13,   6.1000D+02 )
!  Reaction Label R069            
             RKI( NCELL,   78) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 2.9000D-31,   0.0000D+00,  -4.1000D+00,  & 
     &                                                 1.7000D-12,   0.0000D+00,   2.0000D-01,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R070            
             RKI( NCELL,   79) =  CFACT * FALLOFF_T09( INV_TEMP,  CAIR, & 
     &                                                 1.4400D-13,   0.0000D+00,   2.7400D-33,  & 
     &                                                 0.0000D+00 )
!  Reaction Label R071            
             RKI( NCELL,   80) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.4500D-12,  -1.7750D+03 )
!  Reaction Label R072            
             RKI( NCELL,   81) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.6600D-12,  -1.0200D+03 )
!  Reaction Label R073            
             RKI( NCELL,   82) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.6800D-12,  -3.7000D+02 )
!  Reaction Label R074            
             RKI( NCELL,   83) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0100D-11,  -2.4500D+02 )
!  Reaction Label R076            
             RKI( NCELL,   84) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 1.0000D-28,   0.0000D+00,  -4.5000D+00,  & 
     &                                                 8.8000D-12,   0.0000D+00,  -8.5000D-01,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R077            
             RKI( NCELL,   85) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.7200D-12,   5.0000D+02 )
!  Reaction Label R078            
             RKI( NCELL,   86) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.3300D-11,   5.0000D+02 )
!  Reaction Label R080            
             RKI( NCELL,   87) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 5.5000D-30,   0.0000D+00,   0.0000D+00,  & 
     &                                                 8.3000D-13,   0.0000D+00,   2.0000D+00,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label ROCARO31        
             RKI( NCELL,   88) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.3300D-12,  -1.9300D+02 )
!  Reaction Label ROCARO41        
             RKI( NCELL,   89) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8100D-12,   3.5400D+02 )
!  Reaction Label ROCARO51        
             RKI( NCELL,   90) =   2.3300D-11 * CFACT 
!  Reaction Label ROCARO61        
             RKI( NCELL,   91) =   7.1600D-12 * CFACT 
!  Reaction Label R086            
             RKI( NCELL,   92) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-11,   3.9000D+02 )
!  Reaction Label R087            
             RKI( NCELL,   93) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2100D-11,   4.4000D+02 )
!  Reaction Label R088            
             RKI( NCELL,   94) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.2000D-11,   4.0100D+02 )
!  Reaction Label TRP04           
             RKI( NCELL,   95) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.2000D-12,   6.0000D+02 )
!  Reaction Label TRP05           
             RKI( NCELL,   96) =   1.0000D-10 * CFACT 
!  Reaction Label R089            
             RKI( NCELL,   97) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.5000D-12,   1.2500D+02 )
!  Reaction Label R090            
             RKI( NCELL,   98) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.7000D-12,   3.4500D+02 )
!  Reaction Label R091            
             RKI( NCELL,   99) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.9000D-12,   4.0500D+02 )
!  Reaction Label R092            
             RKI( NCELL,  100) =  CFACT * ARRHENUIS_T04( INV_TEMP,  TEMPOT300, & 
     &                                                   4.5600D-14,  -4.2700D+02,   3.6500D+00 )
!  Reaction Label R093            
             RKI( NCELL,  101) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.5000D-12,  -9.0000D+01 )
!  Reaction Label R094            
             RKI( NCELL,  102) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-12,   1.0000D+01 )
!  Reaction Label R095            
             RKI( NCELL,  103) =   3.0000D-12 * CFACT 
!  Reaction Label R096            
             RKI( NCELL,  104) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.0000D-12,   3.8000D+02 )
!  Reaction Label R097            
             RKI( NCELL,  105) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,   6.1000D+02 )
!  Reaction Label R098            
             RKI( NCELL,  106) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.7700D-12,   5.3300D+02 )
!  Reaction Label R099            
             RKI( NCELL,  107) =   1.1000D-11 * CFACT 
!  Reaction Label R100            
             RKI( NCELL,  108) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.2600D-13,   8.3000D+02 )
!  Reaction Label R101            
             RKI( NCELL,  109) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-11,   1.7500D+02 )
!  Reaction Label R102            
             RKI( NCELL,  110) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-11,   1.7500D+02 )
!  Reaction Label R103            
             RKI( NCELL,  111) =   1.0000D-11 * CFACT 
!  Reaction Label R104            
             RKI( NCELL,  112) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.3200D-12,   2.4300D+02 )
!  Reaction Label R105            
             RKI( NCELL,  113) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.7500D-12,   4.0500D+02 )
!  Reaction Label R106            
             RKI( NCELL,  114) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.6500D-11,   0.0000D+00 )
!  Reaction Label R108            
             RKI( NCELL,  115) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0500D-10,   0.0000D+00 )
!  Reaction Label R109            
             RKI( NCELL,  116) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8500D-12,  -3.4500D+02 )
!  Reaction Label R110            
             RKI( NCELL,  117) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.0000D-12,   2.0000D+01 )
!  Reaction Label R111            
             RKI( NCELL,  118) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,   2.0000D+02 )
!  Reaction Label R112            
             RKI( NCELL,  119) =   1.4700D-11 * CFACT 
!  Reaction Label R113            
             RKI( NCELL,  120) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9000D-12,   1.9000D+02 )
!  Reaction Label R114            
             RKI( NCELL,  121) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-12,   1.9000D+02 )
!  Reaction Label TRP06           
             RKI( NCELL,  122) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-12,   1.9000D+02 )
!  Reaction Label R114a           
             RKI( NCELL,  123) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-12,   1.9000D+02 )
!  Reaction Label R115            
             RKI( NCELL,  124) =   1.0000D-10 * CFACT 
!  Reaction Label R116            
             RKI( NCELL,  125) =   3.0000D-11 * CFACT 
!  Reaction Label R117            
             RKI( NCELL,  126) =   4.5000D-13 * CFACT 
!  Reaction Label R118            
             RKI( NCELL,  127) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.0000D-14,   8.5000D+02 )
!  Reaction Label R119            
             RKI( NCELL,  128) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9300D-12,   1.9000D+02 )
!  Reaction Label R120            
             RKI( NCELL,  129) =   4.0000D-14 * CFACT 
!  Reaction Label R121            
             RKI( NCELL,  130) =   4.0000D-14 * CFACT 
!  Reaction Label R122            
             RKI( NCELL,  131) =   3.2000D-11 * CFACT 
!  Reaction Label R123            
             RKI( NCELL,  132) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.3100D-12,  -2.6000D+02 )
!  Reaction Label TRP07           
             RKI( NCELL,  133) =   4.8000D-12 * CFACT 
!  Reaction Label R124            
             RKI( NCELL,  134) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.6000D-12,   2.7000D+02 )
!  Reaction Label R125            
             RKI( NCELL,  135) =   1.3000D-11 * CFACT 
!  Reaction Label R126            
             RKI( NCELL,  136) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.1400D-15,  -2.5800D+03 )
!  Reaction Label R127            
             RKI( NCELL,  137) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.3300D-15,  -1.8000D+03 )
!  Reaction Label R128            
             RKI( NCELL,  138) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.4000D-15,  -8.4500D+02 )
!  Reaction Label R130            
             RKI( NCELL,  139) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.8600D-15,  -1.9130D+03 )
!  Reaction Label R131            
             RKI( NCELL,  140) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.0000D-16,  -5.3000D+02 )
!  Reaction Label R132            
             RKI( NCELL,  141) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9500D-15,  -7.8300D+02 )
!  Reaction Label TRP08           
             RKI( NCELL,  142) =   8.3000D-18 * CFACT 
!  Reaction Label TRP09           
             RKI( NCELL,  143) =   1.6700D-16 * CFACT 
!  Reaction Label R132            
             RKI( NCELL,  144) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.3600D-15,  -2.1120D+03 )
!  Reaction Label R134            
             RKI( NCELL,  145) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.5000D-16,  -1.5200D+03 )
!  Reaction Label R135            
             RKI( NCELL,  146) =   1.6600D-18 * CFACT 
!  Reaction Label R136            
             RKI( NCELL,  147) =   2.0000D-16 * CFACT 
!  Reaction Label R137            
             RKI( NCELL,  148) =   2.0000D-16 * CFACT 
!  Reaction Label R138            
             RKI( NCELL,  149) =   9.0000D-17 * CFACT 
!  Reaction Label R140            
             RKI( NCELL,  150) =   2.8600D-13 * CFACT 
!  Reaction Label R141            
             RKI( NCELL,  151) =  CFACT * ARRHENUIS_T04( INV_TEMP,  TEMPOT300, & 
     &                                                   4.3920D-13,  -2.2820D+03,   2.0000D+00 )
!  Reaction Label R142            
             RKI( NCELL,  152) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7900D-13,  -4.5000D+02 )
!  Reaction Label R143            
             RKI( NCELL,  153) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.6400D-13,   4.5000D+02 )
!  Reaction Label R145            
             RKI( NCELL,  154) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.0300D-12,  -4.4600D+02 )
!  Reaction Label R146            
             RKI( NCELL,  155) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1900D-12,   4.9000D+02 )
!  Reaction Label R147            
             RKI( NCELL,  156) =   1.2200D-11 * CFACT 
!  Reaction Label TRP10           
             RKI( NCELL,  157) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.1500D-14,  -4.4800D+02 )
!  Reaction Label R148            
             RKI( NCELL,  158) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-12,  -2.4400D+03 )
!  Reaction Label R149            
             RKI( NCELL,  159) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-12,  -1.9000D+03 )
!  Reaction Label R150            
             RKI( NCELL,  160) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7600D-12,  -1.9000D+03 )
!  Reaction Label R151            
             RKI( NCELL,  161) =   3.4000D-15 * CFACT 
!  Reaction Label R152            
             RKI( NCELL,  162) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.0200D-13,  -1.0760D+03 )
!  Reaction Label R153            
             RKI( NCELL,  163) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9000D-12,  -1.9000D+03 )
!  Reaction Label R154            
             RKI( NCELL,  164) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7600D-12,  -1.9000D+03 )
!  Reaction Label R155            
             RKI( NCELL,  165) =   3.7800D-12 * CFACT 
!  Reaction Label R156            
             RKI( NCELL,  166) =   1.0600D-12 * CFACT 
!  Reaction Label R158            
             RKI( NCELL,  167) =   2.0100D-10 * CFACT 
!  Reaction Label R159            
             RKI( NCELL,  168) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.2000D-14,  -5.0000D+02 )
!  Reaction Label TRP11           
             RKI( NCELL,  169) =   1.0000D+00 * SFACT 
!  Reaction Label TRP12           
             RKI( NCELL,  170) =   1.0000D+00 * SFACT 
!  Reaction Label R166            
             RKI( NCELL,  171) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 9.7000D-29,   0.0000D+00,  -5.6000D+00,  & 
     &                                                 9.3000D-12,   0.0000D+00,  -1.5000D+00,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R167            
             RKI( NCELL,  172) =  RFACT * RKI( NCELL,  171 ) & 
     &                         * (  1.1111D+28 * DEXP( -1.4000D+04 * INV_TEMP) ) 
!  Reaction Label R168            
             RKI( NCELL,  173) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 9.7000D-29,   0.0000D+00,  -5.6000D+00,  & 
     &                                                 9.3000D-12,   0.0000D+00,  -1.5000D+00,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R169            
             RKI( NCELL,  174) =  RFACT * RKI( NCELL,  173 ) & 
     &                         * (  1.1111D+28 * DEXP( -1.4000D+04 * INV_TEMP) ) 
!  Reaction Label R170            
             RKI( NCELL,  175) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-12,   1.8100D+02 )
!  Reaction Label R171            
             RKI( NCELL,  176) =  SFACT * ARRHENUIS_T03( INV_TEMP,  1.6000D+16,  -1.3486D+04 )
!  Reaction Label R172            
             RKI( NCELL,  177) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-12,   3.0000D+02 )
!  Reaction Label R173            
             RKI( NCELL,  178) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,   3.6500D+02 )
!  Reaction Label R174            
             RKI( NCELL,  179) =   4.0000D-12 * CFACT 
!  Reaction Label R175            
             RKI( NCELL,  180) =   4.0000D-12 * CFACT 
!  Reaction Label R177            
             RKI( NCELL,  181) =   9.0000D-12 * CFACT 
!  Reaction Label R178            
...
!  Reaction Label R190            
             RKI( NCELL,  193) =   4.0000D-12 * CFACT 
...
!  Reaction Label R191            
             RKI( NCELL,  199) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.1000D-12,   2.7000D+02 )
!  Reaction Label R192            
             RKI( NCELL,  200) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.1000D-12,   2.7000D+02 )
!  Reaction Label R193            
             RKI( NCELL,  201) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9000D-12,   3.0000D+02 )
!  Reaction Label R194            
             RKI( NCELL,  202) =   4.0000D-12 * CFACT 
!  Reaction Label R195            
             RKI( NCELL,  203) =   4.0000D-12 * CFACT 
!  Reaction Label R196            
             RKI( NCELL,  204) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5400D-12,   3.6000D+02 )
!  Reaction Label R197            
             RKI( NCELL,  205) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5400D-12,   3.6000D+02 )
!  Reaction Label R198            
             RKI( NCELL,  206) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5400D-12,   3.6000D+02 )
!  Reaction Label R199            
             RKI( NCELL,  207) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5400D-12,   3.6000D+02 )
!  Reaction Label R200            
             RKI( NCELL,  208) =   4.0000D-12 * CFACT 
!  Reaction Label R201            
             RKI( NCELL,  209) =   4.0000D-12 * CFACT 
!  Reaction Label R202            
             RKI( NCELL,  210) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label R203            
...
!  Reaction Label R208            
             RKI( NCELL,  216) =   4.0000D-12 * CFACT 
!  Reaction Label R209            
             RKI( NCELL,  217) =   2.0000D-11 * CFACT 
!  Reaction Label R210            
             RKI( NCELL,  218) =   2.0000D-11 * CFACT 
!  Reaction Label R211            
             RKI( NCELL,  219) =   2.0800D-12 * CFACT 
!  Reaction Label R212            
             RKI( NCELL,  220) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.1000D-13,   7.5000D+02 )
!  Reaction Label R213            
             RKI( NCELL,  221) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5000D-13,   7.0000D+02 )
!  Reaction Label R214            
             RKI( NCELL,  222) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6600D-13,   1.3000D+03 )
!  Reaction Label R215            
             RKI( NCELL,  223) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6600D-13,   1.3000D+03 )
!  Reaction Label R217            
             RKI( NCELL,  224) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.9000D-13,   1.3000D+03 )
!  Reaction Label R218            
             RKI( NCELL,  225) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6600D-13,   1.3000D+03 )
!  Reaction Label R219            
             RKI( NCELL,  226) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6600D-13,   1.3000D+03 )
!  Reaction Label ROCARO32        
             RKI( NCELL,  227) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO42        
             RKI( NCELL,  228) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO52        
             RKI( NCELL,  229) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO62        
             RKI( NCELL,  230) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label R228            
             RKI( NCELL,  231) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0500D-13,   1.3000D+03 )
!  Reaction Label R229            
...
!  Reaction Label TRP28           
             RKI( NCELL,  241) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label R231            
             RKI( NCELL,  242) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.3000D-13,   1.0400D+03 )
!  Reaction Label R232            
             RKI( NCELL,  243) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.3000D-13,   1.0400D+03 )
!  Reaction Label R233            
             RKI( NCELL,  244) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1500D-13,   1.3000D+03 )
!  Reaction Label R234            
             RKI( NCELL,  245) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1500D-13,   1.3000D+03 )
!  Reaction Label R235            
             RKI( NCELL,  246) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1500D-13,   1.3000D+03 )
!  Reaction Label R236            
             RKI( NCELL,  247) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8200D-13,   1.3000D+03 )
!  Reaction Label R237            
             RKI( NCELL,  248) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8200D-13,   1.3000D+03 )
!  Reaction Label R238            
             RKI( NCELL,  249) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label R239            
             RKI( NCELL,  250) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label R240            
             RKI( NCELL,  251) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7500D-13,   9.8000D+02 )
!  Reaction Label R241            
             RKI( NCELL,  252) =   1.0000D-11 * CFACT 
!  Reaction Label R242            
...
!  Reaction Label R244            
             RKI( NCELL,  255) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6600D-13,   1.3000D+03 )
!  Reaction Label R245            
             RKI( NCELL,  256) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6600D-13,   1.3000D+03 )
!  Reaction Label R246            
             RKI( NCELL,  257) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7500D-13,   9.8000D+02 )
!  Reaction Label R247            
             RKI( NCELL,  258) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6600D-13,   1.3000D+03 )
!  Reaction Label R248            
             RKI( NCELL,  259) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.5000D-14,   3.9000D+02 )
!  Reaction Label R249            
             RKI( NCELL,  260) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1800D-13,   1.5800D+02 )
!  Reaction Label R250            
             RKI( NCELL,  261) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.4600D-14,   4.3100D+02 )
!  Reaction Label R251            
             RKI( NCELL,  262) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0000D-13,   4.6700D+02 )
!  Reaction Label R253            
             RKI( NCELL,  263) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7100D-13,   7.0800D+02 )
!  Reaction Label R254            
             RKI( NCELL,  264) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4600D-13,   7.0800D+02 )
!  Reaction Label R255            
             RKI( NCELL,  265) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.1800D-14,   7.0800D+02 )
...
!  Reaction Label ROCARO55        
             RKI( NCELL,  268) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO65        
             RKI( NCELL,  269) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label R264            
             RKI( NCELL,  270) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-14,   2.2100D+02 )
!  Reaction Label R265            
...
!  Reaction Label R267            
             RKI( NCELL,  279) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-11,   5.0000D+02 )
!  Reaction Label R268            
             RKI( NCELL,  280) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-11,   5.0000D+02 )
!  Reaction Label R269            
             RKI( NCELL,  281) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5000D-13,   5.0000D+02 )
!  Reaction Label R270            
             RKI( NCELL,  282) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.9100D-13,   5.0800D+02 )
!  Reaction Label R271            
             RKI( NCELL,  283) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.9100D-13,   5.0800D+02 )
!  Reaction Label R272            
             RKI( NCELL,  284) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-14,   2.2100D+02 )
!  Reaction Label R273            
             RKI( NCELL,  285) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-14,   2.2100D+02 )
!  Reaction Label R274            
             RKI( NCELL,  286) =   8.3700D-14 * CFACT 
!  Reaction Label R275            
             RKI( NCELL,  287) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-14,   2.2100D+02 )
!  Reaction Label R276            
             RKI( NCELL,  288) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label R277            
             RKI( NCELL,  289) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label R278            
             RKI( NCELL,  290) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label R279            
             RKI( NCELL,  291) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label R280            
             RKI( NCELL,  292) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5000D-13,   5.0000D+02 )
!  Reaction Label R281            
             RKI( NCELL,  293) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6000D-13,   7.0800D+02 )
!  Reaction Label R282            
             RKI( NCELL,  294) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.6800D-14,   7.0800D+02 )
!  Reaction Label R283            
             RKI( NCELL,  295) =   3.5600D-14 * CFACT 
!  Reaction Label R284            
             RKI( NCELL,  296) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.9900D-15,   1.5100D+03 )
!  Reaction Label R285            
             RKI( NCELL,  297) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0300D-12,   2.1100D+02 )
!  Reaction Label R286            
             RKI( NCELL,  298) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.9000D-13,   4.6000D+02 )
!  Reaction Label R287            
             RKI( NCELL,  299) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.5900D-13,   5.2200D+02 )
!  Reaction Label R289            
             RKI( NCELL,  300) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.4800D-13,   7.6500D+02 )
!  Reaction Label R290            
             RKI( NCELL,  301) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.1100D-13,   7.6500D+02 )
!  Reaction Label R291            
             RKI( NCELL,  302) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.0900D-13,   7.6500D+02 )
!  Reaction Label ROCARO36        
             RKI( NCELL,  303) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
...
!  Reaction Label R300            
             RKI( NCELL,  307) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.4000D-14,   2.2100D+02 )
!  Reaction Label R301            
...
!  Reaction Label R303            
             RKI( NCELL,  316) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5000D-12,   5.0000D+02 )
!  Reaction Label R304            
             RKI( NCELL,  317) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5000D-12,   5.0000D+02 )
!  Reaction Label R305            
             RKI( NCELL,  318) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5100D-13,   5.6500D+02 )
!  Reaction Label R306            
             RKI( NCELL,  319) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5100D-13,   5.6500D+02 )
!  Reaction Label R307            
             RKI( NCELL,  320) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5100D-13,   5.6500D+02 )
!  Reaction Label R308            
             RKI( NCELL,  321) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.4000D-14,   2.2100D+02 )
!  Reaction Label R309            
             RKI( NCELL,  322) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.4000D-14,   2.2100D+02 )
!  Reaction Label R310            
             RKI( NCELL,  323) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6800D-12,   5.0000D+02 )
!  Reaction Label R311            
             RKI( NCELL,  324) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6800D-12,   5.0000D+02 )
!  Reaction Label R312            
             RKI( NCELL,  325) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label R313            
             RKI( NCELL,  326) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label R314            
             RKI( NCELL,  327) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.0800D+02 )
!  Reaction Label R315            
             RKI( NCELL,  328) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.0800D+02 )
!  Reaction Label R316            
             RKI( NCELL,  329) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5100D-13,   5.6500D+02 )
!  Reaction Label R317            
             RKI( NCELL,  330) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.8500D-13,   7.6500D+02 )
!  Reaction Label R318            
             RKI( NCELL,  331) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.3700D-13,   7.6500D+02 )
!  Reaction Label R319            
             RKI( NCELL,  332) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.0800D+02 )
!  Reaction Label R320            
             RKI( NCELL,  333) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-14,   1.5600D+03 )
!  Reaction Label R321            
             RKI( NCELL,  334) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5000D-12,   5.0000D+02 )
!  Reaction Label R322            
...
!  Reaction Label ROCARO34        
             RKI( NCELL,  342) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO44        
             RKI( NCELL,  343) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO54        
             RKI( NCELL,  344) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO64        
             RKI( NCELL,  345) =   2.3000D-12 * CFACT 
!  Reaction Label R338            
...
!  Reaction Label R341            
             RKI( NCELL,  349) =   4.0000D-12 * CFACT 
!  Reaction Label R342            
             RKI( NCELL,  350) =   4.0000D-12 * CFACT 
!  Reaction Label R343            
...
!  Reaction Label R348            
             RKI( NCELL,  356) =   2.5000D-12 * CFACT 
!  Reaction Label R349            
             RKI( NCELL,  357) =   2.5000D-12 * CFACT 
!  Reaction Label R350            
             RKI( NCELL,  358) =   2.5000D-12 * CFACT 
!  Reaction Label R351            
             RKI( NCELL,  359) =   2.5000D-12 * CFACT 
!  Reaction Label R352            
...
!  Reaction Label R355            
             RKI( NCELL,  363) =   1.2000D-12 * CFACT 
!  Reaction Label R356            
             RKI( NCELL,  364) =   1.2000D-12 * CFACT 
!  Reaction Label R357            
             RKI( NCELL,  365) =   1.2000D-12 * CFACT 
!  Reaction Label R358            
             RKI( NCELL,  366) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.0000D-14,   1.0000D+03 )
!  Reaction Label R359            
             RKI( NCELL,  367) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.2500D-14,   1.0000D+03 )
!  Reaction Label R360            
             RKI( NCELL,  368) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9600D-14,   1.0000D+03 )
!  Reaction Label R361            
             RKI( NCELL,  369) =   1.2000D-12 * CFACT 
!  Reaction Label R362            
             RKI( NCELL,  370) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5000D-12,   5.0000D+02 )
!  Reaction Label R363            
             RKI( NCELL,  371) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.1300D-17,   2.9500D+03 )
...
!  Reaction Label SA14            
             RKI( NCELL,  384) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.7800D-11,  -4.0000D+02 )
!  Reaction Label R001c           
             RKI( NCELL,  385) =   6.8900D-12 * CFACT 
!  Reaction Label R002c           
             RKI( NCELL,  386) =   6.5500D-14 * CFACT 
!  Reaction Label T17             
             RKI( NCELL,  387) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.0000D-12,   3.8000D+02 )
!  Reaction Label T18             
             RKI( NCELL,  388) =   2.9000D-19 * CFACT 
!  Reaction Label T19             
             RKI( NCELL,  389) =   3.4000D-15 * CFACT 
!  Reaction Label T10             
             RKI( NCELL,  391) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4800D-11,   4.4800D+02 )
!  Reaction Label T10a            
             RKI( NCELL,  392) =   9.0500D-12 * CFACT 
!  Reaction Label T10b            
             RKI( NCELL,  393) =   2.3000D-12 * CFACT 
!  Reaction Label T10c            
             RKI( NCELL,  394) =   1.6100D-11 * CFACT 
!  Reaction Label T10d            
             RKI( NCELL,  395) =   2.3900D-12 * CFACT 
!  Reaction Label T10e            
             RKI( NCELL,  396) =   1.3700D-11 * CFACT 
!  Reaction Label T11             
             RKI( NCELL,  397) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.3400D-14,  -2.2830D+03 )
!  Reaction Label T12             
             RKI( NCELL,  398) =   1.0000D-13 * CFACT 
!  Reaction Label R003c           
             RKI( NCELL,  399) =   5.0100D-11 * CFACT 
!  Reaction Label R004c           
             RKI( NCELL,  400) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label R005c           
             RKI( NCELL,  401) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7500D-13,   9.8000D+02 )
!  Reaction Label R006c           
             RKI( NCELL,  402) =   4.4000D-11 * CFACT 
!  Reaction Label R007c           
             RKI( NCELL,  403) =   3.4300D-17 * CFACT 
!  Reaction Label R008c           
             RKI( NCELL,  404) =   8.9900D-12 * CFACT 
!  Reaction Label R010c           
             RKI( NCELL,  405) =   1.2000D-11 * CFACT 
!  Reaction Label R011c           
             RKI( NCELL,  406) =   1.9000D-11 * CFACT 
!  Reaction Label R012c           
             RKI( NCELL,  407) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8400D-13,   1.3000D+03 )
!  Reaction Label R013c           
             RKI( NCELL,  408) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label R014c           
             RKI( NCELL,  409) =   2.3000D-12 * CFACT 
!  Reaction Label R015c           
             RKI( NCELL,  410) =   1.2000D-14 * CFACT 
!  Reaction Label R016c           
             RKI( NCELL,  411) =   1.9700D-10 * CFACT 
!  Reaction Label R017c           
             RKI( NCELL,  412) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8400D-13,   1.3000D+03 )
...
!  Reaction Label HET_GLY         
             RKI( NCELL,  415) =  BLKHET(  NCELL, IK_HETERO_GLY )
!  Reaction Label HET_MGLY        
             RKI( NCELL,  416) =  BLKHET(  NCELL, IK_HETERO_MGLY )
!  Reaction Label HET_N2O5        
             RKI( NCELL,  417) =  BLKHET(  NCELL, IK_HETERO_N2O5IJ )
!  Reaction Label HET_N02         
             RKI( NCELL,  418) =  BLKHET(  NCELL, IK_HETERO_NO2 )
!  Reaction Label HET_IEPOX       
             RKI( NCELL,  420) =  BLKHET(  NCELL, IK_HETERO_IEPOX )
!  Reaction Label HET_ISO3TET     
             RKI( NCELL,  421) =  BLKHET(  NCELL, IK_HETERO_ISO3NOSJ )
!  Reaction Label HET_IEPOXOS     
             RKI( NCELL,  422) =  BLKHET(  NCELL, IK_HETERO_ISO3OSJ )
!  Reaction Label ROCALK1c        
             RKI( NCELL,  423) =   1.5300D-11 * CFACT 
!  Reaction Label ROCALK2c        
             RKI( NCELL,  424) =   1.6800D-11 * CFACT 
!  Reaction Label ROCALK3c        
             RKI( NCELL,  425) =   2.2400D-11 * CFACT 
!  Reaction Label ROCALK4c        
             RKI( NCELL,  426) =   2.6700D-11 * CFACT 
!  Reaction Label ROCALK5c        
             RKI( NCELL,  427) =   3.0900D-11 * CFACT 
!  Reaction Label ROCALK6c        
             RKI( NCELL,  428) =   3.3800D-11 * CFACT 
!  Reaction Label HC1001          
             RKI( NCELL,  429) =   1.1000D-11 * CFACT 
...
!  Reaction Label ROCALK10c       
             RKI( NCELL,  433) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
...
!  Reaction Label ROCALK16c       
             RKI( NCELL,  440) =   2.3000D-12 * CFACT 
...
!  Reaction Label ROCALK19c       
             RKI( NCELL,  444) =   2.1700D-11 * CFACT 
!  Reaction Label ROCALK20c       
             RKI( NCELL,  445) =   2.2000D-11 * CFACT 
!  Reaction Label ROCALK21c       
             RKI( NCELL,  446) =   2.2500D-11 * CFACT 
!  Reaction Label ROCALK22c       
             RKI( NCELL,  447) =   2.2600D-11 * CFACT 
!  Reaction Label ROCALK23c       
             RKI( NCELL,  448) =   2.2700D-11 * CFACT 
!  Reaction Label ROCALK24c       
             RKI( NCELL,  449) =   2.2700D-11 * CFACT 
!  Reaction Label HC1004          
             RKI( NCELL,  450) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6600D-13,   1.3000D+03 )
...
!  Reaction Label ROCALK28c       
             RKI( NCELL,  454) =   1.8800D-01 * SFACT 
...
!  Reaction Label ROCALK34c       
             RKI( NCELL,  461) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
...
!  Reaction Label ROCALK40c       
             RKI( NCELL,  468) =   2.3000D-12 * CFACT 
...
!  Reaction Label ROCALK43c       
             RKI( NCELL,  472) =   2.1700D-11 * CFACT 
!  Reaction Label ROCALK44c       
             RKI( NCELL,  473) =   2.2000D-11 * CFACT 
!  Reaction Label ROCALK45c       
             RKI( NCELL,  474) =   2.2500D-11 * CFACT 
!  Reaction Label ROCALK46c       
             RKI( NCELL,  475) =   2.2600D-11 * CFACT 
!  Reaction Label ROCALK47c       
             RKI( NCELL,  476) =   2.2700D-11 * CFACT 
!  Reaction Label ROCALK48c       
             RKI( NCELL,  477) =   2.2700D-11 * CFACT 
!  Reaction Label HC1008          
             RKI( NCELL,  478) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6600D-13,   1.3000D+03 )
!  Reaction Label ROCARO01        
             RKI( NCELL,  479) =   1.8100D-11 * CFACT 
!  Reaction Label ROCARO02        
             RKI( NCELL,  480) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO03        
             RKI( NCELL,  481) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO04        
             RKI( NCELL,  482) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO05        
             RKI( NCELL,  483) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO06        
             RKI( NCELL,  484) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label ROCARO11        
             RKI( NCELL,  485) =   1.8100D-11 * CFACT 
!  Reaction Label ROCARO12        
             RKI( NCELL,  486) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO13        
             RKI( NCELL,  487) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO14        
             RKI( NCELL,  488) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO15        
             RKI( NCELL,  489) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO16        
             RKI( NCELL,  490) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label ROCARO21        
             RKI( NCELL,  491) =   2.3100D-11 * CFACT 
!  Reaction Label ROCARO22        
             RKI( NCELL,  492) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO23        
             RKI( NCELL,  493) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO24        
             RKI( NCELL,  494) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO25        
             RKI( NCELL,  495) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO26        
             RKI( NCELL,  496) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label ROCOXY1c        
             RKI( NCELL,  497) =   5.9000D-11 * CFACT 
!  Reaction Label ROCOXY2c        
             RKI( NCELL,  498) =   6.0700D-11 * CFACT 
!  Reaction Label ROCOXY3c        
             RKI( NCELL,  499) =   5.5400D-11 * CFACT 
!  Reaction Label ROCOXY4c        
             RKI( NCELL,  500) =   5.6300D-11 * CFACT 
!  Reaction Label ROCOXY5c        
             RKI( NCELL,  501) =   5.4600D-11 * CFACT 
!  Reaction Label ROCOXY6c        
             RKI( NCELL,  502) =   4.5000D-11 * CFACT 
!  Reaction Label ROCOXY7c        
             RKI( NCELL,  503) =   5.1700D-11 * CFACT 
!  Reaction Label ROCOXY8c        
             RKI( NCELL,  504) =   4.7300D-11 * CFACT 
!  Reaction Label ROCOXY9c        
             RKI( NCELL,  505) =   4.6000D-11 * CFACT 
!  Reaction Label ROCOXY10c       
             RKI( NCELL,  506) =   3.8000D-11 * CFACT 
!  Reaction Label ROCOXY11c       
             RKI( NCELL,  507) =   3.9300D-11 * CFACT 
!  Reaction Label ROCOXY12c       
             RKI( NCELL,  508) =   3.5200D-11 * CFACT 
!  Reaction Label ROCOXY13c       
             RKI( NCELL,  509) =   3.1200D-11 * CFACT 
!  Reaction Label ROCOXY14c       
             RKI( NCELL,  510) =   2.4000D-11 * CFACT 
!  Reaction Label ROCOXY15c       
             RKI( NCELL,  511) =   2.0500D-11 * CFACT 
!  Reaction Label ROCOXY16c       
             RKI( NCELL,  512) =   4.6900D-11 * CFACT 
