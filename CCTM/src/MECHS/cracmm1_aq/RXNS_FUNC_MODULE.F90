...
!  Reaction Label HET_ISO3TET     
             RKI( NCELL,  412) =  BLKHET(  NCELL, IK_HETERO_ISO3NOSJ )
!  Reaction Label HET_IEPOXOS     
             RKI( NCELL,  413) =  BLKHET(  NCELL, IK_HETERO_ISO3OSJ )
!  Reaction Label ROCALK1c        
             RKI( NCELL,  414) =   1.5300D-11 * CFACT 
!  Reaction Label ROCALK2c        
             RKI( NCELL,  415) =   1.6800D-11 * CFACT 
!  Reaction Label ROCALK3c        
             RKI( NCELL,  416) =   2.2400D-11 * CFACT 
!  Reaction Label ROCALK4c        
             RKI( NCELL,  417) =   2.6700D-11 * CFACT 
!  Reaction Label ROCALK5c        
             RKI( NCELL,  418) =   3.0900D-11 * CFACT 
!  Reaction Label ROCALK6c        
             RKI( NCELL,  419) =   3.3800D-11 * CFACT 
!  Reaction Label HC1001          
             RKI( NCELL,  420) =   1.1000D-11 * CFACT 
...
!  Reaction Label ROCALK19c       
             RKI( NCELL,  435) =   2.1700D-11 * CFACT 
!  Reaction Label ROCALK20c       
             RKI( NCELL,  436) =   2.2000D-11 * CFACT 
!  Reaction Label ROCALK21c       
             RKI( NCELL,  437) =   2.2500D-11 * CFACT 
!  Reaction Label ROCALK22c       
             RKI( NCELL,  438) =   2.2600D-11 * CFACT 
!  Reaction Label ROCALK23c       
             RKI( NCELL,  439) =   2.2700D-11 * CFACT 
!  Reaction Label ROCALK24c       
             RKI( NCELL,  440) =   2.2700D-11 * CFACT 
!  Reaction Label HC1004          
             RKI( NCELL,  441) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6600D-13,   1.3000D+03 )
...
!  Reaction Label HC1008          
             RKI( NCELL,  469) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6600D-13,   1.3000D+03 )
!  Reaction Label ROCARO01        
             RKI( NCELL,  470) =   1.8100D-11 * CFACT 
!  Reaction Label ROCARO02        
             RKI( NCELL,  471) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
...
!  Reaction Label ROCARO05        
             RKI( NCELL,  474) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO06        
             RKI( NCELL,  475) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label ROCARO11        
             RKI( NCELL,  476) =   1.8100D-11 * CFACT 
!  Reaction Label ROCARO12        
             RKI( NCELL,  477) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
...
!  Reaction Label ROCARO15        
             RKI( NCELL,  480) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO16        
             RKI( NCELL,  481) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label ROCARO21        
             RKI( NCELL,  482) =   2.3100D-11 * CFACT 
!  Reaction Label ROCARO22        
             RKI( NCELL,  483) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO23        
             RKI( NCELL,  484) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO24        
             RKI( NCELL,  485) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO25        
             RKI( NCELL,  486) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO26        
             RKI( NCELL,  487) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label ROCOXY1c        
             RKI( NCELL,  488) =   5.9000D-11 * CFACT 
!  Reaction Label ROCOXY2c        
             RKI( NCELL,  489) =   6.0700D-11 * CFACT 
!  Reaction Label ROCOXY3c        
             RKI( NCELL,  490) =   5.5400D-11 * CFACT 
!  Reaction Label ROCOXY4c        
             RKI( NCELL,  491) =   5.6300D-11 * CFACT 
!  Reaction Label ROCOXY5c        
             RKI( NCELL,  492) =   5.4600D-11 * CFACT 
!  Reaction Label ROCOXY6c        
             RKI( NCELL,  493) =   4.5000D-11 * CFACT 
!  Reaction Label ROCOXY7c        
             RKI( NCELL,  494) =   5.1700D-11 * CFACT 
!  Reaction Label ROCOXY8c        
             RKI( NCELL,  495) =   4.7300D-11 * CFACT 
!  Reaction Label ROCOXY9c        
             RKI( NCELL,  496) =   4.6000D-11 * CFACT 
!  Reaction Label ROCOXY10c       
             RKI( NCELL,  497) =   3.8000D-11 * CFACT 
!  Reaction Label ROCOXY11c       
             RKI( NCELL,  498) =   3.9300D-11 * CFACT 
!  Reaction Label ROCOXY12c       
             RKI( NCELL,  499) =   3.5200D-11 * CFACT 
!  Reaction Label ROCOXY13c       
             RKI( NCELL,  500) =   3.1200D-11 * CFACT 
!  Reaction Label ROCOXY14c       
             RKI( NCELL,  501) =   2.4000D-11 * CFACT 
!  Reaction Label ROCOXY15c       
             RKI( NCELL,  502) =   2.0500D-11 * CFACT 
!  Reaction Label ROCOXY16c       
             RKI( NCELL,  503) =   4.6900D-11 * CFACT 
