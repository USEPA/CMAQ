...
set DataPath   = /work/MAQSEA/tspero/mcip/$Expt
set InMetDir   = $DataPath/input/subset
set InTerDir   = $DataPath/terrain
set InSatDir   = $DataPath/goes
set OutDir     = $DataPath/output
set ProgDir    = /home/tspero/mcip/mcip_v4-5/MCIP4/mcip4
set WorkDir    = $OutDir
...
if ( -f $GRID_CRO_3D ) rm -f $GRID_CRO_3D
