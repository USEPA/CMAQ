...
C $Header: /project/yoj/arc/ICON/src/mech_conv/radm2_to_saprc07t/saprc07t_table.f,v 1.1 2011/09/12 16:31:35 yoj Exp $

      module saprc07t_table

      integer, parameter :: nsptab = 54    ! No. of SAPRC07T species defined in this table
...
C                 tab_spc     |   radm2_spc( 1 )    |
     ...
     & mech_conv( 'MECO3   ', 1, (/'ACO3   '/), (/ 1.0 /)),   ! 23
     & mech_conv( 'PAN     ', 1, (/'PAN    '/), (/ 1.0 /)),   ! 24
     & mech_conv( 'CCOOOH  ', 1, (/'PAA    '/), (/ 1.0 /)),   ! 25
     & mech_conv( 'CCOOH   ', 1, (/'ORA2   '/), (/ 1.0 /)),   ! 26
     ...
     & mech_conv( 'MACR    ', 1, (/'MACR   '/), (/ 1.0 /)),   ! 33
     & mech_conv( 'MVK     ', 1, (/'MVK    '/), (/ 1.0 /)),   ! 34
     & mech_conv( 'IPRD    ', 1, (/'ISOPROD'/), (/ 1.0 /)),   ! 35
     & mech_conv( 'AFG2    ', 1, (/'DCB    '/), (/ 1.0 /)),   ! 36
     & mech_conv( 'ETHENE  ', 1, (/'OL2    '/), (/ 1.0 /)),   ! 37
     & mech_conv( 'ISOPRENE', 1, (/'ISO    '/), (/ 1.0 /)),   ! 38
     & mech_conv( 'TERP    ', 1, (/'TERP   '/), (/ 1.0 /)),   ! 39
     ...
     & mech_conv( 'TOLUENE ', 1, (/'TOL    '/), (/ 1.0 /)),   ! 45
     & mech_conv( 'MXYL    ', 1, (/'XYL    '/), (/ 0.34/)),   ! 46
     & mech_conv( 'OXYL    ', 1, (/'XYL    '/), (/ 0.33/)),   ! 47
     & mech_conv( 'PXYL    ', 1, (/'XYL    '/), (/ 0.33/)),   ! 48
     & mech_conv( 'OLE1    ', 1, (/'OLT    '/), (/ 1.0 /)),   ! 49
     & mech_conv( 'OLE2    ', 1, (/'OLI    '/), (/ 1.0 /)),   ! 50
     & mech_conv( 'BENZENE ', 1, (/'BENZENE'/), (/ 1.0 /)),   ! 51
     & mech_conv( 'HG      ', 1, (/'HG     '/), (/ 1.0 /)),   ! 52
     & mech_conv( 'HGIIGAS ', 1, (/'HGIIGAS'/), (/ 1.0 /)),   ! 53
     & mech_conv( 'CO2     ', 1, (/'CO2    '/), (/ 1.0 /)) /) ! 54

      character( 128 ) :: line1 = " SAPRC07T gas mechanism with AERO5 species and toxics"
!     character( 128 ) :: out_fl_name = "/home/yoj/src/icon/mech_conv/radm2_to_saprc07t/ic_profile_SAPRC07T.dat"
      include './out_fl_name.ext'
      character(  52 ) :: str = ' in RADM2 part of SAPRC07T list, not in profile data'

      end module saprc07t_table
