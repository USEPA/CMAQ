...
C $Header: /project/work/rep/arc/ICON/src/mech_conv/radm2_to_saprc99/saprc99_table.f,v 1.1 2011/09/12 16:31:36 yoj Exp $
...
C                 tab_spc     |   radm2_spc( 1 )    |
     ...
     & mech_conv( 'HGIIGAS ', 1, (/'HGIIGAS'/), (/ 1.0 /)) /) ! 56
      ...
      character( 128 ) :: line1 = " RACM2 gas mechanism with AERO5 species and toxics"
!     character( 128 ) :: out_fl_name = "/home/yoj/src/icon/mech_conv/radm2_to_racm2/ic_profile_RACM2.dat"
