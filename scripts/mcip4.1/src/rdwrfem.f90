...
!-------------------------------------------------------------------------------
  ...
  REAL, PARAMETER :: sfz0nlcsum ( 50 ) = &  ! summer [cm]
    (/  0.1,   1.2,  30.0,  40.0,  60.0, 100.0,   5.0,   5.0,  &
      100.0, 100.0, 100.0,  10.0,  30.0,   7.0,   7.0,   5.0,  &
        5.0,   5.0,   7.0,  10.0,  55.0,  80.0,  30.0,  60.0,  &
       30.0,  11.0,  11.0,  11.0,   5.0,   5.0,   0.1, 100.0,  &
       90.0, 100.0, 100.0, 100.0,  30.0,  20.0,  25.0,  15.0,  &
        7.0,  20.0,  10.0,  80.0,  10.0,   1.2,   5.0,   0.1,  &
        0.1,   0.1 /)

  REAL, PARAMETER :: sfz0nlcwin ( 50 ) = &  ! winter [cm]
    (/  0.1,   1.2,  30.0,  40.0,  60.0, 100.0,   5.0,   5.0,  &
      100.0, 100.0, 100.0,  10.0,  30.0,   7.0,   7.0,   5.0,  &
        5.0,   5.0,   7.0,  10.0,  55.0,  80.0,  30.0,  60.0,  &
       30.0,  11.0,  11.0,  11.0,   5.0,   5.0,   0.1, 100.0,  &
        ...
        DO j = 1, nym
          DO i = 1, nxm
            ...
            ELSE IF ( met_lu_src(1:3) == "NLC" ) THEN
              znt(i,j) = sfz0nlcsum(landuse(i,j))  * 0.01  ! cm --> m
      ...
      ELSE IF ( met_season == 2 ) THEN  ! winter
        ...
        DO j = 1, nym
          DO i = 1, nxm
            ...
            ELSE IF ( met_lu_src(1:3) == "NLC" ) THEN
              znt(i,j) = sfz0nlcwin(landuse(i,j))  * 0.01  ! cm --> m
            ELSE IF ( met_lu_src(1:3) == "SIB" ) THEN
