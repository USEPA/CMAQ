...
# action if the output files already exist ...
 ...
 setenv EMIS_DGN        "$OUTDIR/$EMISDGN -v"
 setenv STATICS_DGN     "$OUTDIR/$STATDGN -v"
 setenv BDRY_DGN        "$OUTDIR/$BDRYDGN -v"
 setenv DDEPOS_DGN      "$OUTDIR/$DDEPDGN -v"
 setenv WDEPOS_DGN      "$OUTDIR/$WDEPDGN -v"
 setenv CHEM_DGN        "$OUTDIR/$CHEMDGN -v"
 setenv ACTIVE_DGN      "$OUTDIR/$ACTVDGN -v"
 setenv DUMP_DGN        "$OUTDIR/$DUMPDGN -v"
