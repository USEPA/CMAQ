...
! $Header: /project/work/rep/MCIP2/src/mcip2/init_x.F,v 1.8 2007/08/03 20:51:55 tlotte Exp $ 
...
!-------------------------------------------------------------------------------
  ...
  xq2     (:,:)   = badval3  ;    xqfx    (:,:)   = badval3
  xradyn  (:,:)   = badval3  ;    xrainc  (:,:)   = badval3
  xrainn  (:,:)   = badval3  ;    xrgrnd  (:,:)   = badval3
  xrib    (:,:)   = badval3  ;    xrstom  (:,:)   = badval3
