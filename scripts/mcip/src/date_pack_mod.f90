...
! $Header: /project/work/rep/MCIP2/src/mcip2/date_pack_mod.F,v 1.2 2005/08/29 14:29:55 tlotte Exp $ 
...
!-------------------------------------------------------------------------------
   ...
   CHARACTER(LEN=19)           ::     old_date
   CHARACTER(LEN=19)           ::   start_date
   CHARACTER(LEN=19)           ::    test_date
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   SUBROUTINE geth_idts (newdate, olddate, idts)
      ...
      IF (newlen.GE.13) THEN
         READ(ndate(12:13),'(I2)') hrnew
         IF (newlen.GE.16) THEN
            READ(ndate(15:16),'(I2)') minew
            IF (newlen.GE.19) THEN
