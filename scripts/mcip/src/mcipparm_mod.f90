...
! $Header: /project/work/rep/MCIP2/src/mcip2/mcipparm_mod.F,v 1.5 2007/08/03 20:53:47 tlotte Exp $ 
...
!-------------------------------------------------------------------------------
  ...
  INTEGER, PARAMETER :: lddgas =  31  ! number of gas species for dry dep
...
!-------------------------------------------------------------------------------
  ...
  INTEGER :: lddep           ! user input: 0 = Do not calculate dry dep vel
                             !             4 = Models-3 (Pleim) dry dep vel
...
!-------------------------------------------------------------------------------
  ...
  CHARACTER*80                 :: fdesc      ( mxdesc3 )
  CHARACTER*16,  PARAMETER     :: progname   = 'MCIP'
  CHARACTER*10,  PARAMETER     :: vdate      = '03/19/2010'
  CHARACTER*8,   PARAMETER     :: ver        = 'V3.6'
