...
**Important notice about the 5.3.3 branch: An inadvertant merge to this 5.3.3 branch on January 17, 2023 added code from CMAQv5.4.  This caused the code to no longer compile and to include many updates to the source code that were not part of CMAQv5.3.3. This issue was corrected on March 6, 2023.  The 5.3.3 branch is now identical with the tagged version: [CMAQv5.3.3_17Aug2021](https://github.com/USEPA/CMAQ/releases/tag/CMAQv5.3.3_17Aug2021). The January 17th merge did not impact the tagged version of CMAQv5.3.3 or the zip file attached to the Zenodo DOI.**
