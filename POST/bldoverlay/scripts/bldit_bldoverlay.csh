...
#> Source Code Repository
 setenv REPOROOT ${CMAQ_REPO}/POST/bldoverlay  #> location of the source code for BLDOVERLAY
...
# set CompileBLDMAKE  #> Recompile the BLDMAKE utility from source
 ...
 set ModDriver = src #> BLDOVERLAY Modules
...
#============================================================================================
#> Set up the bldoverlay build directory under the Tools directory
#> for checking out and compiling source code
#============================================================================================
 set Bld = ${CMAQ_HOME}/POST/bldoverlay/scripts/BLD_bldoverlay_${VRSN}_${compiler}
