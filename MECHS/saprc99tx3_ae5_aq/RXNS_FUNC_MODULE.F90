...
! Name of Mechanism SAPRC99TX3_AE5_AQ
...
!  Reaction Label acHV            
                RKI( NCELL,  229) =   2.0000D-03 * RJBLK( NCELL, IJ_ACROLEIN_SAPRC99 )
!  Reaction Label P1              
                RKI( NCELL,  234) =  RJBLK( NCELL, IJ_HCHO_R_SAPRC99 )
!  Reaction Label P2              
                RKI( NCELL,  235) =  RJBLK( NCELL, IJ_HCHO_M_SAPRC99 )
!  Reaction Label P7              
                RKI( NCELL,  240) =  RJBLK( NCELL, IJ_CCHO_R_SAPRC99 )
!  Reaction Label P14             
                RKI( NCELL,  246) =   2.0000D-03 * RJBLK( NCELL, IJ_ACROLEIN_SAPRC99 )
            END DO 
        END IF 
...
!  Reaction Label o1OH            
             RKI( NCELL,  208) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.1000D-12,   4.5100D+02 )
!  Reaction Label o1O3            
             RKI( NCELL,  209) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6200D-15,  -1.6400D+03 )
!  Reaction Label o1N3            
             RKI( NCELL,  210) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.4500D-14,  -3.7600D+02 )
!  Reaction Label o1OP            
             RKI( NCELL,  211) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0700D-11,  -2.3400D+02 )
!  Reaction Label o2OH            
             RKI( NCELL,  212) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7400D-11,   3.8400D+02 )
!  Reaction Label o2O3            
             RKI( NCELL,  213) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.0200D-16,  -4.6100D+02 )
!  Reaction Label o2N3            
             RKI( NCELL,  214) =   7.2600D-13 * CFACT 
!  Reaction Label o2OP            
             RKI( NCELL,  215) =   2.0900D-11 * CFACT 
!  Reaction Label I1OH            
             RKI( NCELL,  216) =   4.5000D-13 * CFACT 
!  Reaction Label I2OH            
             RKI( NCELL,  217) =   8.0000D-13 * CFACT 
!  Reaction Label I3OH            
             RKI( NCELL,  218) =   1.1600D-12 * CFACT 
!  Reaction Label SSO3            
             RKI( NCELL,  219) =   1.1600D-14 * CFACT 
!  Reaction Label SSOH            
             RKI( NCELL,  220) =   1.9700D-10 * CFACT 
!  Reaction Label SSN3            
             RKI( NCELL,  221) =   1.9000D-11 * CFACT 
!  Reaction Label BENZ            
             RKI( NCELL,  222) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.4700D-12,  -2.0600D+02 )
!  Reaction Label BNZN            
...
!  Reaction Label acOH            
             RKI( NCELL,  225) =   1.9900D-11 * CFACT 
!  Reaction Label acO3            
             RKI( NCELL,  226) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.3600D-15,  -2.5190D+03 )
!  Reaction Label acN3            
             RKI( NCELL,  227) =   2.9380D-15 * CFACT 
!  Reaction Label acOP            
             RKI( NCELL,  228) =   2.3670D-12 * CFACT 
!  Reaction Label bdOH            
             RKI( NCELL,  230) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4800D-11,   4.4800D+02 )
!  Reaction Label bdO3            
             RKI( NCELL,  231) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.3400D-14,  -2.2830D+03 )
!  Reaction Label bdN3            
             RKI( NCELL,  232) =   1.0000D-13 * CFACT 
!  Reaction Label bdOP            
             RKI( NCELL,  233) =   1.9800D-11 * CFACT 
!  Reaction Label P3              
             RKI( NCELL,  236) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.6000D-12,   2.0000D+01 )
!  Reaction Label P4              
             RKI( NCELL,  237) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.7000D-15,   6.2500D+02 )
!  Reaction Label P5              
             RKI( NCELL,  238) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-12,  -2.4310D+03 )
!  Reaction Label P6              
             RKI( NCELL,  239) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.6000D-12,   3.1000D+02 )
!  Reaction Label P8              
             RKI( NCELL,  241) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-12,  -1.8600D+03 )
!  Reaction Label P10             
             RKI( NCELL,  242) =   1.9900D-11 * CFACT 
!  Reaction Label P11             
             RKI( NCELL,  243) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.3600D-15,  -2.5190D+03 )
!  Reaction Label P12             
             RKI( NCELL,  244) =   2.9380D-15 * CFACT 
!  Reaction Label P13             
             RKI( NCELL,  245) =   2.3670D-12 * CFACT 
