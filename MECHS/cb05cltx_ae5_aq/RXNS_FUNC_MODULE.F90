...
! Name of Mechanism CB05CLTX_AE5_AQ
...
!  Reaction Label R135            
                RKI( NCELL,  135) =   9.0000D+00 * RJBLK( NCELL, IJ_HCHO_R_SAPRC99 )
!  Reaction Label R140            
                RKI( NCELL,  140) =  RJBLK( NCELL, IJ_MGLY_IUPAC04 )
!  Reaction Label R148            
                RKI( NCELL,  148) =   3.6000D-03 * RJBLK( NCELL, IJ_ACROLEIN_SAPRC99 )
!  Reaction Label CL1             
                RKI( NCELL,  157) =  RJBLK( NCELL, IJ_CL2_IUPAC04 )
!  Reaction Label CL2             
                RKI( NCELL,  158) =  RJBLK( NCELL, IJ_HOCL_IUPAC04 )
!  Reaction Label CL8             
                RKI( NCELL,  164) =  RJBLK( NCELL, IJ_FMCL_IUPAC04 )
!  Reaction Label T04             
                RKI( NCELL,  191) =  RJBLK( NCELL, IJ_HCHO_R_SAPRC99 )
!  Reaction Label T05             
                RKI( NCELL,  192) =  RJBLK( NCELL, IJ_HCHO_M_SAPRC99 )
!  Reaction Label T09             
                RKI( NCELL,  197) =  RJBLK( NCELL, IJ_CCHO_R_SAPRC99 )
!  Reaction Label T17             
                RKI( NCELL,  207) =  RJBLK( NCELL, IJ_ACROLEIN_SAPRC99 )
!  Reaction Label T21             
                RKI( NCELL,  212) =  RJBLK( NCELL, IJ_ACROLEIN_SAPRC99 )
            END DO 
        END IF 
...
!  Reaction Label R18             
     ...
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R19             
             RKI( NCELL,   19) =   2.5000D-22 * CFACT 
!  Reaction Label R20             
             RKI( NCELL,   20) =   1.8000D-39 * CFACT_SQU 
!  Reaction Label R21             
...
!  Reaction Label R129            
             RKI( NCELL,  129) =   8.1000D-12 * CFACT 
!  Reaction Label R130            
             RKI( NCELL,  130) =   4.2000D+00 * SFACT 
!  Reaction Label R131            
             RKI( NCELL,  131) =   4.1000D-11 * CFACT 
!  Reaction Label R132            
             RKI( NCELL,  132) =   2.2000D-11 * CFACT 
!  Reaction Label R133            
             RKI( NCELL,  133) =   1.4000D-11 * CFACT 
!  Reaction Label R134            
             RKI( NCELL,  134) =   5.5000D-12 * CFACT 
!  Reaction Label R136            
             RKI( NCELL,  136) =   3.0000D-11 * CFACT 
!  Reaction Label R137            
             RKI( NCELL,  137) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.4000D-17,  -5.0000D+02 )
!  Reaction Label R138            
             RKI( NCELL,  138) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-11,   1.1600D+02 )
!  Reaction Label R139            
             RKI( NCELL,  139) =   1.8000D-11 * CFACT 
!  Reaction Label R141            
             RKI( NCELL,  141) =   3.6000D-11 * CFACT 
!  Reaction Label R142            
             RKI( NCELL,  142) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5400D-11,   4.0760D+02 )
!  Reaction Label R143            
             RKI( NCELL,  143) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.8600D-15,  -1.9120D+03 )
!  Reaction Label R144            
             RKI( NCELL,  144) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.0300D-12,  -4.4800D+02 )
!  Reaction Label R145            
             RKI( NCELL,  145) =   3.3600D-11 * CFACT 
!  Reaction Label R146            
             RKI( NCELL,  146) =   7.1000D-18 * CFACT 
!  Reaction Label R147            
             RKI( NCELL,  147) =   1.0000D-15 * CFACT 
!  Reaction Label R149            
             RKI( NCELL,  149) =   3.6000D-11 * CFACT 
!  Reaction Label R150            
             RKI( NCELL,  150) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.5000D-11,   4.4900D+02 )
!  Reaction Label R151            
             RKI( NCELL,  151) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-15,  -8.2100D+02 )
!  Reaction Label R152            
             RKI( NCELL,  152) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7000D-12,   1.7500D+02 )
!  Reaction Label R153            
             RKI( NCELL,  153) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 3.0000D-31,   0.0000D+00,  -3.3000D+00,  & 
     &                                                 1.5000D-12,   0.0000D+00,   0.0000D+00,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R154            
             RKI( NCELL,  154) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.9000D-12,  -2.3000D+02 )
!  Reaction Label R155            
             RKI( NCELL,  155) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.7000D-12,  -1.0700D+03 )
!  Reaction Label R156            
             RKI( NCELL,  156) =   1.5000D-19 * CFACT 
!  Reaction Label CL3             
             RKI( NCELL,  159) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.3000D-11,  -2.0000D+02 )
!  Reaction Label CL4             
             RKI( NCELL,  160) =   1.6300D-14 * CFACT 
!  Reaction Label CL5             
             RKI( NCELL,  161) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.4000D-12,   2.9000D+02 )
!  Reaction Label CL6             
             RKI( NCELL,  162) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   2.2000D+02 )
!  Reaction Label CL7             
             RKI( NCELL,  163) =   5.0000D-13 * CFACT 
!  Reaction Label CL9             
             RKI( NCELL,  165) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.6000D-12,  -1.2400D+03 )
!  Reaction Label CL10            
             RKI( NCELL,  166) =   5.0000D-11 * CFACT 
!  Reaction Label CL11            
             RKI( NCELL,  167) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.3000D-11,  -1.0000D+02 )
!  Reaction Label CL12            
             RKI( NCELL,  168) =   1.0700D-10 * CFACT 
!  Reaction Label CL13            
             RKI( NCELL,  169) =   2.5000D-10 * CFACT 
!  Reaction Label CL14            
             RKI( NCELL,  170) =   3.5000D-10 * CFACT 
!  Reaction Label CL15            
             RKI( NCELL,  171) =   4.3000D-10 * CFACT 
!  Reaction Label CL16            
             RKI( NCELL,  172) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.2000D-11,  -3.4000D+01 )
!  Reaction Label CL17            
             RKI( NCELL,  173) =   7.9000D-11 * CFACT 
!  Reaction Label CL18            
             RKI( NCELL,  174) =   1.3000D-10 * CFACT 
!  Reaction Label CL19            
             RKI( NCELL,  175) =   5.5000D-11 * CFACT 
!  Reaction Label CL20            
             RKI( NCELL,  176) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.2000D-11,   4.5000D+01 )
!  Reaction Label CL21            
             RKI( NCELL,  177) =  CFACT * ARRHENUIS_T04( INV_TEMP,  TEMPOT300, & 
     &                                                   6.5800D-13,   5.8000D+01,   1.1600D+00 )
!  Reaction Label SA01            
             RKI( NCELL,  178) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label SA02            
             RKI( NCELL,  179) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.9000D-13,   1.3000D+03 )
!  Reaction Label SA03            
             RKI( NCELL,  180) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label SA04            
             RKI( NCELL,  181) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.9000D-13,   1.3000D+03 )
!  Reaction Label SA05            
             RKI( NCELL,  182) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.4700D-12,  -2.0600D+02 )
!  Reaction Label SA06            
             RKI( NCELL,  183) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label SA07            
             RKI( NCELL,  184) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.9000D-13,   1.3000D+03 )
!  Reaction Label SA08            
             RKI( NCELL,  185) =   1.1600D-14 * CFACT 
!  Reaction Label SA09            
             RKI( NCELL,  186) =   1.9700D-10 * CFACT 
!  Reaction Label SA10            
             RKI( NCELL,  187) =   1.9000D-11 * CFACT 
!  Reaction Label T01             
             RKI( NCELL,  188) =   9.0000D-12 * CFACT 
!  Reaction Label T02             
             RKI( NCELL,  189) =   5.8000D-16 * CFACT 
!  Reaction Label T03             
             RKI( NCELL,  190) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-11,  -1.6000D+03 )
!  Reaction Label TCL1            
             RKI( NCELL,  193) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.2000D-11,  -3.4000D+01 )
!  Reaction Label T06             
             RKI( NCELL,  194) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.6000D-12,   2.7000D+02 )
!  Reaction Label T07             
             RKI( NCELL,  195) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-12,  -1.9000D+03 )
!  Reaction Label T08             
             RKI( NCELL,  196) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8000D-11,  -1.1000D+03 )
!  Reaction Label TCL2            
             RKI( NCELL,  198) =   7.9000D-11 * CFACT 
!  Reaction Label T10             
             RKI( NCELL,  199) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-11,   4.2400D+02 )
!  Reaction Label T11             
             RKI( NCELL,  200) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.2000D-15,  -2.0700D+03 )
!  Reaction Label T12             
             RKI( NCELL,  201) =   1.7900D-13 * CFACT 
!  Reaction Label T13             
             RKI( NCELL,  202) =  CFACT * ARRHENUIS_T04( INV_TEMP,  TEMPOT300, & 
     &                                                   3.9900D-12,   3.9500D+02,   1.4500D+00 )
!  Reaction Label TCL3            
             RKI( NCELL,  203) =   2.5100D-10 * CFACT 
!  Reaction Label T14             
             RKI( NCELL,  204) =   2.0000D-11 * CFACT 
!  Reaction Label T15             
             RKI( NCELL,  205) =   2.6100D-19 * CFACT 
!  Reaction Label T16             
             RKI( NCELL,  206) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-11,  -3.1310D+03 )
!  Reaction Label TCL4            
             RKI( NCELL,  208) =   2.3700D-10 * CFACT 
!  Reaction Label T18             
             RKI( NCELL,  209) =   2.0000D-11 * CFACT 
!  Reaction Label T19             
             RKI( NCELL,  210) =   2.6100D-19 * CFACT 
!  Reaction Label T20             
             RKI( NCELL,  211) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-11,  -3.1310D+03 )
!  Reaction Label TCL5            
             RKI( NCELL,  213) =   2.3700D-10 * CFACT 
!  Reaction Label T22             
             RKI( NCELL,  214) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8000D-12,   3.5500D+02 )
!  Reaction Label TCL6            
             RKI( NCELL,  215) =   6.1000D-11 * CFACT 
!  Reaction Label T23             
             RKI( NCELL,  216) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-11,   1.1600D+02 )
!  Reaction Label TCL7            
             RKI( NCELL,  217) =   1.4000D-10 * CFACT 
!  Reaction Label T24             
             RKI( NCELL,  218) =   1.2200D-11 * CFACT 
!  Reaction Label TCL8            
             RKI( NCELL,  219) =   1.5000D-10 * CFACT 
!  Reaction Label T25             
             RKI( NCELL,  220) =   1.3000D-11 * CFACT 
!  Reaction Label TCL9            
             RKI( NCELL,  221) =   1.5000D-10 * CFACT 
!  Reaction Label T26             
             RKI( NCELL,  222) =   2.7900D-11 * CFACT 
!  Reaction Label T27             
             RKI( NCELL,  223) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-11,   4.4000D+02 )
!  Reaction Label T28             
             RKI( NCELL,  224) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.3000D-16,  -5.8000D+02 )
!  Reaction Label T29             
             RKI( NCELL,  225) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-12,   4.9000D+02 )
!  Reaction Label TCL10           
             RKI( NCELL,  226) =   4.7000D-10 * CFACT 
!  Reaction Label T30             
             RKI( NCELL,  227) =   2.8100D-11 * CFACT 
!  Reaction Label T31             
             RKI( NCELL,  228) =   7.5100D-11 * CFACT 
!  Reaction Label T32             
             RKI( NCELL,  229) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7400D-15,  -1.2600D+03 )
!  Reaction Label T33             
             RKI( NCELL,  230) =   2.8100D-11 * CFACT 
!  Reaction Label TCL11           
             RKI( NCELL,  231) =   5.3000D-10 * CFACT 
!  Reaction Label HET_N2O5        
             RKI( NCELL,  232) =  BLKHET(  NCELL, IK_HETERO_N2O5IJ )
!  Reaction Label HET_N02         
             RKI( NCELL,  233) =  BLKHET(  NCELL, IK_HETERO_NO2 )
...
!  Reaction Label OLIG_BENZENE1   
             RKI( NCELL,  239) =   9.4882D-06 * SFACT 
!  Reaction Label OLIG_BENZENE2   
             RKI( NCELL,  240) =   9.4882D-06 * SFACT 
!  Reaction Label OLIG_TERPENE1   
             RKI( NCELL,  241) =   9.4882D-06 * SFACT 
!  Reaction Label OLIG_TERPENE2   
             RKI( NCELL,  242) =   9.4882D-06 * SFACT 
!  Reaction Label OLIG_ISOPRENE1  
             RKI( NCELL,  243) =   9.4882D-06 * SFACT 
!  Reaction Label OLIG_ISOPRENE2  
             RKI( NCELL,  244) =   9.4882D-06 * SFACT 
!  Reaction Label OLIG_SESQT1     
             RKI( NCELL,  245) =   9.4882D-06 * SFACT 
