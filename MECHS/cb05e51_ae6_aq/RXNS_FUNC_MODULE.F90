...
!  Reaction Label R164            
                RKI( NCELL,  177) =   3.6000D-03 * RJBLK( NCELL, IJ_ACRO_09 )
!  Reaction Label CL1             
                RKI( NCELL,  191) =  RJBLK( NCELL, IJ_CL2_IUPAC04 )
!  Reaction Label CL2             
                RKI( NCELL,  192) =  RJBLK( NCELL, IJ_HOCL_IUPAC04 )
!  Reaction Label CL8             
                RKI( NCELL,  198) =  RJBLK( NCELL, IJ_FMCL_IUPAC04 )
!  Reaction Label CL25            
                RKI( NCELL,  216) =  RJBLK( NCELL, IJ_CLNO2 )
!  Reaction Label N024            
...
!  Reaction Label T04             
                RKI( NCELL,  291) =  RJBLK( NCELL, IJ_FORM_R_IUPAC10 )
!  Reaction Label T05             
                RKI( NCELL,  292) =  RJBLK( NCELL, IJ_FORM_M_IUPAC10 )
!  Reaction Label T09             
                RKI( NCELL,  297) =  RJBLK( NCELL, IJ_ALD2_R_IUPAC10 )
!  Reaction Label T17             
                RKI( NCELL,  306) =  RJBLK( NCELL, IJ_ACRO_09 )
!  Reaction Label T21             
                RKI( NCELL,  311) =  RJBLK( NCELL, IJ_ACRO_09 )

                IF( .NOT. LAND( NCELL ) )THEN
!  Reaction Label HAL_Ozone       
                   RKI( NCELL,  267) =  SFACT * HALOGEN_FALLOFF( BLKPRES( NCELL ),   1.0000D-40,   7.8426D+01,  & 
...
!  Reaction Label I010a           
             RKI( NCELL,  168) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5000D-13,   7.0000D+02 )
!  Reaction Label I010b           
             RKI( NCELL,  169) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,   3.6500D+02 )
!  Reaction Label I010c           
             RKI( NCELL,  170) =   2.3000D-13 * CFACT 
!  Reaction Label I010d           
             RKI( NCELL,  171) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.4000D-13,   1.0700D+03 )
!  Reaction Label R159            
             RKI( NCELL,  172) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.8600D-15,  -1.9120D+03 )
!  Reaction Label R160            
             RKI( NCELL,  173) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.0300D-12,  -4.4800D+02 )
!  Reaction Label R161            
             RKI( NCELL,  174) =   3.3600D-11 * CFACT 
!  Reaction Label R162            
             RKI( NCELL,  175) =   7.1000D-18 * CFACT 
!  Reaction Label R163            
             RKI( NCELL,  176) =   1.0000D-15 * CFACT 
!  Reaction Label R165            
             RKI( NCELL,  178) =   3.6000D-11 * CFACT 
!  Reaction Label R166            
             RKI( NCELL,  179) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.5000D-11,   4.4900D+02 )
!  Reaction Label I014            
             RKI( NCELL,  180) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,   3.6500D+02 )
!  Reaction Label I015            
             RKI( NCELL,  181) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5000D-13,   7.0000D+02 )
!  Reaction Label I016            
             RKI( NCELL,  182) =   6.8000D-14 * CFACT 
!  Reaction Label I017            
             RKI( NCELL,  183) =   6.8000D-14 * CFACT 
!  Reaction Label I018            
             RKI( NCELL,  184) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.4000D-13,   1.0700D+03 )
!  Reaction Label R167            
             RKI( NCELL,  185) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-15,  -8.2100D+02 )
!  Reaction Label R168            
             RKI( NCELL,  186) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7000D-12,   1.7500D+02 )
!  Reaction Label R169            
             RKI( NCELL,  187) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 3.3000D-31,   0.0000D+00,  -4.3000D+00,  & 
     &                                                 1.6000D-12,   0.0000D+00,   0.0000D+00,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R170            
             RKI( NCELL,  188) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.9000D-12,  -2.3000D+02 )
!  Reaction Label R171            
             RKI( NCELL,  189) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.7000D-12,  -1.0700D+03 )
!  Reaction Label R172            
             RKI( NCELL,  190) =   1.5000D-19 * CFACT 
!  Reaction Label CL3             
             RKI( NCELL,  193) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.3000D-11,  -2.0000D+02 )
!  Reaction Label CL4             
             RKI( NCELL,  194) =   1.6300D-14 * CFACT 
!  Reaction Label CL5             
             RKI( NCELL,  195) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.4000D-12,   2.9000D+02 )
!  Reaction Label CL6             
             RKI( NCELL,  196) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   2.2000D+02 )
!  Reaction Label CL7             
             RKI( NCELL,  197) =   5.0000D-13 * CFACT 
!  Reaction Label CL9             
             RKI( NCELL,  199) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.6000D-12,  -1.2400D+03 )
!  Reaction Label CL10            
             RKI( NCELL,  200) =   5.0000D-11 * CFACT 
!  Reaction Label CL11            
             RKI( NCELL,  201) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.3000D-11,  -1.0000D+02 )
!  Reaction Label CL12            
             RKI( NCELL,  202) =   1.0700D-10 * CFACT 
!  Reaction Label CL13            
             RKI( NCELL,  203) =   2.5000D-10 * CFACT 
!  Reaction Label CL14            
             RKI( NCELL,  204) =   3.5000D-10 * CFACT 
!  Reaction Label CL15            
             RKI( NCELL,  205) =   4.3000D-10 * CFACT 
!  Reaction Label CL16            
             RKI( NCELL,  206) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.2000D-11,  -3.4000D+01 )
!  Reaction Label CL17            
             RKI( NCELL,  207) =   7.9000D-11 * CFACT 
!  Reaction Label CL18            
             RKI( NCELL,  208) =   1.3000D-10 * CFACT 
!  Reaction Label CL19            
             RKI( NCELL,  209) =   5.5000D-11 * CFACT 
!  Reaction Label CL20            
             RKI( NCELL,  210) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.2000D-11,   4.5000D+01 )
!  Reaction Label CL21            
             RKI( NCELL,  211) =  CFACT * ARRHENUIS_T04( INV_TEMP,  TEMPOT300, & 
     &                                                   6.5800D-13,   5.8000D+01,   1.1600D+00 )
!  Reaction Label CL22            
             RKI( NCELL,  212) =   6.1000D-11 * CFACT 
!  Reaction Label CL23a           
             RKI( NCELL,  213) =   1.2000D-10 * CFACT 
!  Reaction Label CL23b           
             RKI( NCELL,  214) =   1.2000D-10 * CFACT 
!  Reaction Label CL24            
             RKI( NCELL,  215) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
...
!  Reaction Label SA05            
             RKI( NCELL,  221) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.4700D-12,  -2.0600D+02 )
!  Reaction Label SA06            
             RKI( NCELL,  222) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label SA07            
             RKI( NCELL,  223) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.9000D-13,   1.3000D+03 )
!  Reaction Label SA08            
             RKI( NCELL,  224) =   1.1600D-14 * CFACT 
!  Reaction Label SA09            
             RKI( NCELL,  225) =   1.9700D-10 * CFACT 
!  Reaction Label SA10            
             RKI( NCELL,  226) =   1.9000D-11 * CFACT 
!  Reaction Label SA11            
             RKI( NCELL,  227) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label SA12            
             RKI( NCELL,  228) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.9000D-13,   1.3000D+03 )
!  Reaction Label SA13            
             RKI( NCELL,  229) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.7400D+02 )
!  Reaction Label N001            
             RKI( NCELL,  230) =   2.9000D-11 * CFACT 
!  Reaction Label N002            
             RKI( NCELL,  231) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.3000D-13,   1.0400D+03 )
!  Reaction Label N003            
             RKI( NCELL,  232) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-12,   5.0000D+02 )
!  Reaction Label N004            
             RKI( NCELL,  233) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9000D-12,   5.0000D+02 )
!  Reaction Label N005            
             RKI( NCELL,  234) =   1.2900D-12 * CFACT 
!  Reaction Label N006            
             RKI( NCELL,  235) =   7.2600D-12 * CFACT 
!  Reaction Label N007            
             RKI( NCELL,  236) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,   3.6500D+02 )
!  Reaction Label N008            
             RKI( NCELL,  237) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5000D-13,   7.0000D+02 )
!  Reaction Label N009            
             RKI( NCELL,  238) =   6.8000D-14 * CFACT 
!  Reaction Label R010            
             RKI( NCELL,  239) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.4000D-13,   1.0700D+03 )
!  Reaction Label N011            
             RKI( NCELL,  240) =   2.5000D-13 * CFACT 
!  Reaction Label N012            
             RKI( NCELL,  241) =   1.1000D-12 * CFACT 
!  Reaction Label N013            
             RKI( NCELL,  242) =   5.7000D-12 * CFACT 
!  Reaction Label N014            
             RKI( NCELL,  243) =   3.3000D-11 * CFACT 
!  Reaction Label N015            
...
!  Reaction Label N017            
             RKI( NCELL,  246) =   2.5000D-13 * CFACT 
!  Reaction Label N018            
             RKI( NCELL,  247) =   5.0000D-12 * CFACT 
!  Reaction Label N019            
             RKI( NCELL,  248) =   2.8300D-12 * CFACT 
!  Reaction Label N020            
             RKI( NCELL,  249) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label N021            
             RKI( NCELL,  250) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0500D-13,   1.3000D+03 )
!  Reaction Label N022            
             RKI( NCELL,  251) =   2.5000D-13 * CFACT 
!  Reaction Label N023            
             RKI( NCELL,  252) =   5.0000D-12 * CFACT 
!  Reaction Label HET_N2O5IJ      
             RKI( NCELL,  259) =  BLKHET(  NCELL, IK_HETERO_N2O5IJ )
!  Reaction Label HET_N2O5K       
             RKI( NCELL,  260) =  BLKHET(  NCELL, IK_HETERO_N2O5K )
!  Reaction Label HET_H2NO3PIJA   
             RKI( NCELL,  261) =  BLKHET(  NCELL, IK_HETERO_H2NO3PAIJ )
!  Reaction Label HET_H2NO3PKA    
             RKI( NCELL,  262) =  BLKHET(  NCELL, IK_HETERO_H2NO3PAK )
!  Reaction Label HET_H2NO3PIB    
             RKI( NCELL,  263) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBIJ )
!  Reaction Label HET_H2NO3PJB    
             RKI( NCELL,  264) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBIJ )
!  Reaction Label HET_H2NO3PKB    
             RKI( NCELL,  265) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBK )
!  Reaction Label HET_N02         
             RKI( NCELL,  266) =  BLKHET(  NCELL, IK_HETERO_NO2 )
!  Reaction Label HET_IEPOX       
             RKI( NCELL,  268) =  BLKHET(  NCELL, IK_HETERO_IEPOX )
...
!  Reaction Label RPOAGEPI        
             RKI( NCELL,  284) =   2.5000D-12 * CFACT 
!  Reaction Label RPOAGELI        
             RKI( NCELL,  285) =  BLKHET(  NCELL, IK_HETERO_PNCOMLI )
!  Reaction Label RPOAGEPJ        
             RKI( NCELL,  286) =   2.5000D-12 * CFACT 
!  Reaction Label RPOAGELJ        
             RKI( NCELL,  287) =  BLKHET(  NCELL, IK_HETERO_PNCOMLJ )
!  Reaction Label T01             
             RKI( NCELL,  288) =   9.0000D-12 * CFACT 
!  Reaction Label T02             
             RKI( NCELL,  289) =   5.8000D-16 * CFACT 
!  Reaction Label T03             
             RKI( NCELL,  290) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-11,  -1.6000D+03 )
!  Reaction Label TCL1            
             RKI( NCELL,  293) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.2000D-11,  -3.4000D+01 )
!  Reaction Label T06             
             RKI( NCELL,  294) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.6000D-12,   2.7000D+02 )
!  Reaction Label T07             
             RKI( NCELL,  295) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-12,  -1.9000D+03 )
!  Reaction Label T08             
             RKI( NCELL,  296) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8000D-11,  -1.1000D+03 )
!  Reaction Label TCL2            
             RKI( NCELL,  298) =   7.9000D-11 * CFACT 
!  Reaction Label T10             
             RKI( NCELL,  299) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-11,   4.2400D+02 )
!  Reaction Label T11             
             RKI( NCELL,  300) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.2000D-15,  -2.0700D+03 )
!  Reaction Label T12             
             RKI( NCELL,  301) =   1.7900D-13 * CFACT 
!  Reaction Label TCL3            
             RKI( NCELL,  302) =   2.5100D-10 * CFACT 
!  Reaction Label T14             
             RKI( NCELL,  303) =   2.0000D-11 * CFACT 
!  Reaction Label T15             
             RKI( NCELL,  304) =   2.6100D-19 * CFACT 
!  Reaction Label T16             
             RKI( NCELL,  305) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-11,  -3.1310D+03 )
!  Reaction Label TCL4            
             RKI( NCELL,  307) =   2.3700D-10 * CFACT 
!  Reaction Label T18             
             RKI( NCELL,  308) =   2.0000D-11 * CFACT 
!  Reaction Label T19             
             RKI( NCELL,  309) =   2.6100D-19 * CFACT 
!  Reaction Label T20             
             RKI( NCELL,  310) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-11,  -3.1310D+03 )
!  Reaction Label TCL5            
             RKI( NCELL,  312) =   2.3700D-10 * CFACT 
!  Reaction Label T22             
             RKI( NCELL,  313) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8000D-12,   3.5500D+02 )
!  Reaction Label TCL6            
             RKI( NCELL,  314) =   6.1000D-11 * CFACT 
!  Reaction Label T23             
             RKI( NCELL,  315) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-11,   1.1600D+02 )
!  Reaction Label TCL7            
             RKI( NCELL,  316) =   1.4000D-10 * CFACT 
!  Reaction Label T24             
             RKI( NCELL,  317) =   1.2200D-11 * CFACT 
!  Reaction Label TCL8            
             RKI( NCELL,  318) =   1.5000D-10 * CFACT 
!  Reaction Label T25             
             RKI( NCELL,  319) =   1.3000D-11 * CFACT 
!  Reaction Label TCL9            
             RKI( NCELL,  320) =   1.5000D-10 * CFACT 
!  Reaction Label T26             
             RKI( NCELL,  321) =   2.7900D-11 * CFACT 
!  Reaction Label T27             
             RKI( NCELL,  322) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-11,   4.4000D+02 )
!  Reaction Label T28             
             RKI( NCELL,  323) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.3000D-16,  -5.8000D+02 )
!  Reaction Label T29             
             RKI( NCELL,  324) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-12,   4.9000D+02 )
!  Reaction Label TCL10           
             RKI( NCELL,  325) =   4.7000D-10 * CFACT 
!  Reaction Label T30             
             RKI( NCELL,  326) =   2.8100D-11 * CFACT 
!  Reaction Label T31             
             RKI( NCELL,  327) =   7.5100D-11 * CFACT 
!  Reaction Label T32             
             RKI( NCELL,  328) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7400D-15,  -1.2600D+03 )
!  Reaction Label T33             
             RKI( NCELL,  329) =   2.8100D-11 * CFACT 
!  Reaction Label TCL11           
             RKI( NCELL,  330) =   5.3000D-10 * CFACT 
!  Reaction Label HG1             
             RKI( NCELL,  331) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.1100D-18,  -1.2565D+03 )
!  Reaction Label HG2             
             RKI( NCELL,  332) =   2.6000D-18 * CFACT 
!  Reaction Label HG3             
             RKI( NCELL,  333) =   8.5000D-19 * CFACT 
!  Reaction Label HG4             
             RKI( NCELL,  334) =   7.7000D-14 * CFACT 
!  Reaction Label HG5             
             RKI( NCELL,  335) =  CFACT_SQU * ARRHENUIS_T03( INV_TEMP,  2.2500D-33,  -6.8000D+02 )
