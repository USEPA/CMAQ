...
!  Reaction Label T04             
                RKI( NCELL,  292) =  RJBLK( NCELL, IJ_FORM_R_IUPAC10 )
!  Reaction Label T05             
                RKI( NCELL,  293) =  RJBLK( NCELL, IJ_FORM_M_IUPAC10 )
!  Reaction Label T09             
                RKI( NCELL,  298) =  RJBLK( NCELL, IJ_ALD2_R_IUPAC10 )
!  Reaction Label T17             
                RKI( NCELL,  307) =  RJBLK( NCELL, IJ_ACRO_09 )
!  Reaction Label T21             
                RKI( NCELL,  312) =  RJBLK( NCELL, IJ_ACRO_09 )

                IF( .NOT. LAND( NCELL ) )THEN
!  Reaction Label HAL_Ozone       
                   RKI( NCELL,  268) =  SFACT * HALOGEN_FALLOFF( BLKPRES( NCELL ),   8.3300D-47,   9.3220D+01,  & 
...
!  Reaction Label RPOAGEPI        
             RKI( NCELL,  285) =   2.5000D-12 * CFACT 
!  Reaction Label RPOAGELI        
             RKI( NCELL,  286) =  BLKHET(  NCELL, IK_HETERO_PNCOMLI )
!  Reaction Label RPOAGEPJ        
             RKI( NCELL,  287) =   2.5000D-12 * CFACT 
!  Reaction Label RPOAGELJ        
             RKI( NCELL,  288) =  BLKHET(  NCELL, IK_HETERO_PNCOMLJ )
!  Reaction Label T01             
             RKI( NCELL,  289) =   9.0000D-12 * CFACT 
!  Reaction Label T02             
             RKI( NCELL,  290) =   5.8000D-16 * CFACT 
!  Reaction Label T03             
             RKI( NCELL,  291) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-11,  -1.6000D+03 )
!  Reaction Label TCL1            
             RKI( NCELL,  294) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.2000D-11,  -3.4000D+01 )
!  Reaction Label T06             
             RKI( NCELL,  295) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.6000D-12,   2.7000D+02 )
!  Reaction Label T07             
             RKI( NCELL,  296) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-12,  -1.9000D+03 )
!  Reaction Label T08             
             RKI( NCELL,  297) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8000D-11,  -1.1000D+03 )
!  Reaction Label TCL2            
             RKI( NCELL,  299) =   7.9000D-11 * CFACT 
!  Reaction Label T10             
             RKI( NCELL,  300) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-11,   4.2400D+02 )
!  Reaction Label T11             
             RKI( NCELL,  301) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.2000D-15,  -2.0700D+03 )
!  Reaction Label T12             
             RKI( NCELL,  302) =   1.7900D-13 * CFACT 
!  Reaction Label TCL3            
             RKI( NCELL,  303) =   2.5100D-10 * CFACT 
!  Reaction Label T14             
...
!  Reaction Label T18             
             RKI( NCELL,  309) =   2.0000D-11 * CFACT 
!  Reaction Label T19             
             RKI( NCELL,  310) =   2.6100D-19 * CFACT 
!  Reaction Label T20             
             RKI( NCELL,  311) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-11,  -3.1310D+03 )
!  Reaction Label TCL5            
             RKI( NCELL,  313) =   2.3700D-10 * CFACT 
!  Reaction Label T22             
             RKI( NCELL,  314) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8000D-12,   3.5500D+02 )
!  Reaction Label TCL6            
             RKI( NCELL,  315) =   6.1000D-11 * CFACT 
!  Reaction Label T23             
             RKI( NCELL,  316) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7000D-11,   1.1600D+02 )
!  Reaction Label TCL7            
             RKI( NCELL,  317) =   1.4000D-10 * CFACT 
!  Reaction Label T24             
             RKI( NCELL,  318) =   1.2200D-11 * CFACT 
!  Reaction Label TCL8            
             RKI( NCELL,  319) =   1.5000D-10 * CFACT 
!  Reaction Label T25             
             RKI( NCELL,  320) =   1.3000D-11 * CFACT 
!  Reaction Label TCL9            
             RKI( NCELL,  321) =   1.5000D-10 * CFACT 
!  Reaction Label T26             
             RKI( NCELL,  322) =   2.7900D-11 * CFACT 
!  Reaction Label T27             
             RKI( NCELL,  323) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-11,   4.4000D+02 )
!  Reaction Label T28             
             RKI( NCELL,  324) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.3000D-16,  -5.8000D+02 )
!  Reaction Label T29             
             RKI( NCELL,  325) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-12,   4.9000D+02 )
!  Reaction Label TCL10           
             RKI( NCELL,  326) =   4.7000D-10 * CFACT 
!  Reaction Label T30             
             RKI( NCELL,  327) =   2.8100D-11 * CFACT 
!  Reaction Label T31             
             RKI( NCELL,  328) =   7.5100D-11 * CFACT 
!  Reaction Label T32             
             RKI( NCELL,  329) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7400D-15,  -1.2600D+03 )
!  Reaction Label T33             
             RKI( NCELL,  330) =   2.8100D-11 * CFACT 
!  Reaction Label TCL11           
             RKI( NCELL,  331) =   5.3000D-10 * CFACT 
!  Reaction Label HG1             
