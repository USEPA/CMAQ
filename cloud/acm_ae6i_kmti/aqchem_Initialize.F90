...
! End INLINED initializations
  ...
  RCONST(108) = ((KMTF(0.02D0,1.0D-5,118.13D0)))
  RCONST(109) = ((KMTF(0.02D0,1.0D-5,102.0D0)))
  RCONST(110) = ((KMTF(0.02D0,1.0D-5,102.0D0)))
  RCONST(111) = ((KMTB(2.7D+06,0.0d0,0.02D0,1.0D-5,118.13D0)))
  RCONST(112) = ((KMTB(1.2D+05,0.0d0,0.02D0,1.0D-5,102.0D0)))
  RCONST(113) = ((KMTB(1.2D+05,0.0d0,0.02D0,1.0D-5,102.0D0)))
