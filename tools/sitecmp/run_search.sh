...
# $Header: /nas01/depts/ie/cempd/apps/CMAQ/v5.0.1/CMAQv5.0.1/models/TOOLS/src/sitecmp/run_search.sh,v 1.1.1.1 2012/04/19 19:48:37 sjr Exp $ 
#
...
#
#  comparing the CMAQ model run I2a dataset with SEARCH dataset
#
...
# Set TABLE TYPE
TABLE_TYPE=SEARCH; export TABLE_TYPE
...
# made in the combine extract to convert to ug/m3.
   ...
   GAS_1="o3,ppb,O3,,ozone";  export GAS_1 
   GAS_2="co,ppb,CO,,CO";  export GAS_2 
   GAS_3="so2,ppb,SO2,,sulfur";  export GAS_3 
   GAS_4="no,ppb,NO,,NO";  export GAS_4 
   GAS_5="hno3,ppb,HNO3,,nitric acid";  export GAS_5 
...
SITE_FILE=${BASE}/search/obs/sites.txt; export SITE_FILE

# : input table (exported file from Excel) 
#   containing site-id, time-period, and data fields
IN_TABLE=${BASE}/search/obs/GasMet.csv; export IN_TABLE
...
OUT_TABLE=${BASE}/search/output/I2a.sitecmpV1.0.search.200101.csv; export OUT_TABLE
