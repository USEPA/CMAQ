...
C $Header: /project/yoj/arc/CCTM/src/aero/aero5/Attic/aero_subs.f,v 1.1 2010/07/20 11:55:06 yoj Exp $
...
C *** ARGUMENTS
      ...
      REAL    DV_SO4          ! molecular diffusivity of H2SO4 vapor 
                              ! after correction for ambient conditions
      REAL( 8 ) :: MINM2( NMODES ) ! min 2nd moment in each mode [m**2/m**3]
