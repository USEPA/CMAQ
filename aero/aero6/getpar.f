...
C-----------------------------------------------------------------------
     ...
     &                       aeromode_dens, aeromode_logstd, aeromode_diam, aeromode_mass,
...
C  aeromode_logstd  log of geometric standard deviation
...
C *** Set bounds for ln(Sg)**2
      ...
      If ( limit_sg ) Then
         minl2sg = aeromode_logstd ** 2
         maxl2sg = aeromode_logstd ** 2
      Else
