...
1. Gas and aerosol cheistry mechanisms have been updated to include more recent scienntific understanding. The Carbon Bond mechanism was updated to version 6r5. The Community Regional Atmospheric Chemistry Multiphase Mechanism (CRACMM) is introduced with detailed representation of the chemistry of the Reactive Organic Carbon system including a fully bottom-up implementation of SOA formation from volatile precursors.
2. Two models of aerosol and gas land surface exchange are maintained: M3DRY and STAGE. The representation of aerosol dry deposition has been updated using data from more recent field measurements. Three algorithms are available for modeling aerosol deposition.  
