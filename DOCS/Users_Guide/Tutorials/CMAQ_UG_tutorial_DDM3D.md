...
### Step 1: Download and run the CMAQv5.4 cb6r5 benchmark case (without DDM3D) to confirm that your model run is consistent with the provided benchmark output.
...
The following gridmask file is provided with the benchmark inputs in the CMAQv5.4_2018_12NE3_Benchmark_2Day_Input/2018_12NE3 directory (see step 10 below)
