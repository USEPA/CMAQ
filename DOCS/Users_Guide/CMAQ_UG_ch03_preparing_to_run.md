...
1. Expand on system check from tutorial:
Fortran compilers, Git, I/O API, netCDF, MPI, required libraries, 

2. Provide compiler recommendation, min hardware requirements

3. section on installing libraries 
