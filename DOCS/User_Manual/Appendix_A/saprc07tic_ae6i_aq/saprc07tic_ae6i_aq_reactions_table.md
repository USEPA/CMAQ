...
|<BL16>|TERP + OH = 0.734*xHO2 + 0.064*xRCO3 + 1.211*RO2C + 0.201*RO2XC + 0.201*zMTNO3 + 0.001*xCO + 0.411*xHCHO + 0.385*xRCHO + 0.037*xACETONE + 0.007*xMEK + 0.003*xMGLY + 0.009*xBACL + 0.003*xMVK + 0.002*xIPRD + 0.409*xPROD2 + yR6OOH + TRPRXN + 4.375*XC|2.27e-11*exp<sup>(435/T)</sup>| zRNO3 product replaced with zMTNO3 for SOA purposes | Pye 2015 |
|<BL17>|TERP + O3 = 0.078*HO2 + 0.046*xHO2 + 0.499*OH + 0.202*xMECO3 + 0.059*xRCO3 + 0.49*RO2C + 0.121*RO2XC + 0.121*zMTNO3 + 0.249*CO + 0.063*CO2 + 0.127*HCHO + 0.033*xHCHO + 0.208*xRCHO + 0.057*xACETONE + 0.002*MEK + 0.172*HCOOH + 0.068*RCOOH + 0.003*xMGLY + 0.039*xBACL + 0.002*xMACR + 0.001*xIPRD + 0.502*PRD2 + 0.428*yR6OOH + TRPRXN + 3.852*XC|8.28e-16*exp<sup>(-785/T)</sup>|zRNO3 replaced with zMTNO3 for SOA purposes | Pye 2015 |
|<BL18>|TERP + NO3 = TERPNRO2|1.33e-12*exp<sup>(490/T)</sup>|no longer forms TRPXN for SOA | Pye 2015 |
...
|<BL18b>|TERPNRO2 + HO2 = 1.0*MTNO3|2.65e-13*exp<sup>(1300/T)</sup>| | Pye 2015 |
...
|<TR03>|HCHO_PRIMARY + OH = OH|5.40e-12*exp<sup>(135/T)</sup>| | |
|<TR05>|HCHO_PRIMARY + NO3 = NO3|2.00e-12*exp<sup>(-2431/T)</sup>| | |
|<TR06>|HCHO_PRIMARY + CL = CL|8.10e-11*exp<sup>(-30/T)</sup>| | |
|<TR07>|CCHO_PRIMARY + OH = OH|4.40e-12*exp<sup>(365/T)</sup>| | |
|<TR08>|CCHO_PRIMARY = |1.0/<CCHO_R>| | |
|<TR09>|CCHO_PRIMARY + NO3 = NO3|1.40e-12*exp<sup>(-1860/T)</sup>| | |
|<TR10>|CCHO_PRIMARY + CL = CL|8.00e-11| | |
|<TR11>|ACRO_PRIMARY + OH = OH|1.99e-11| | |
|<TR12>|ACRO_PRIMARY + O3 = O3|1.40e-15*exp<sup>(-2528/T)</sup>| | |
...
|<IS1>|ISOPRENE + OH = ISOPO2 + ISOPRXN|2.54e-11*exp<sup>(410/T)</sup>| | |
|<IS2>|ISOPO2 + NO = 0.40*MVK + 0.26*MACR + 0.883*NO2 + 0.07*ISOPND + 0.047*ISOPNB + 0.66*HCHO + 0.10*HC5 + 0.043*ARO2MN + 0.08*DIBOO + 0.803*HO2|2.60e-12*exp<sup>(380/T)</sup>|  ARO2-->ARO2MN| |
|<IS3>|ISOPO2 + HO2 = 0.880*ISOPOOH + 0.120*OH + 0.047*MACR + 0.073*MVK + 0.120*HO2 + 0.120*HCHO|2.06e-13*exp<sup>(1300/T)</sup>| | |
...
|<IS7>|ISOPO2 + MECO3 = MEO2 + CO2 + 0.91*HO2 + 0.75*HCHO + 0.45*MVK + 0.29*MACR + 0.09*DIBOO + 0.11*HC5 + 0.05*ARO2MN-0.16*XC|4.40e-13*exp<sup>(1070/T)</sup>|  ARO2-->ARO2MN| |
|<IS107>|ISOPO2 = HO2 + HPALD|4.07e8*exp<sup>(-7694/T)</sup>| | |
|<IS137>|HPALD = OH + HO2 + 0.5*HACET + 0.5*MGLY + 0.25*HOCCHO + 0.25*GLY + HCHO|1.0/<HPALD>| | |
|<IS138>|HPALD + OH = OH + PRD2-XC|4.60e-11| | |
|<IS9>|ISOPRENE + NO3 = NISOPO2|3.03e-12*exp<sup>(-448/T)</sup>| | |
|<IS10>|NISOPO2 + NO3 = 0.70*NIT1 + 0.035*MVK + 0.035*MACR + 1.3*NO2 + 0.80*HO2 + 0.070*HCHO + 0.23*HC5|2.30e-12| | |
|<IS11>|NISOPO2 + NO = 0.70*NIT1 + 0.035*MVK + 0.035*MACR + 1.3*NO2 + 0.80*HO2 + 0.070*HCHO + 0.23*HC5|2.60e-12*exp<sup>(380/T)</sup>| | |
|<IS12>|NISOPO2 + HO2 = NISOPOOH|2.06e-13*exp<sup>(1300/T)</sup>| | |
...
|<IS15>|NISOPO2 + MECO3 = MEO2 + CO2 + 0.70*NIT1 + 0.035*MVK + 0.035*MACR + 0.3*NO2 + 0.80*HO2 + 0.070*HCHO + 0.23*HC5|4.40e-13*exp<sup>(1070/T)</sup>| | |
|<IS17>|HC5 + OH = HC5OO|1.42e-11*exp<sup>(610/T)</sup>| | |
|<IS18>|HC5OO + NO = NO2 + 0.234*HOCCHO + 0.234*MGLY + 0.216*GLY + 0.216*HACET + 0.29*DHMOB + 0.17*RCOOH + 0.09*PRD2 + 0.09*CO + HO2 + 0.16*XC|2.60e-12*exp<sup>(380/T)</sup>| | |
|<IS19>|HC5OO + HO2 = R6OOH-XC|2.06e-13*exp<sup>(1300/T)</sup>| | |
...
|<IS22>|HC5OO + MECO3 = MEO2 + CO2 + 0.234*HOCCHO + 0.234*MGLY + 0.216*GLY + 0.216*HACET + 0.29*DHMOB + 0.17*RCOOH + 0.09*PRD2 + 0.09*CO + HO2 + 0.16*XC|4.40e-13*exp<sup>(1070/T)</sup>| | |
|<IS24>|HC5 + O3 = 0.50*MGLY + 0.35*GLY + 0.79*OH + 0.02*HCHO + 0.35*HOCCHO + 0.59*CO + 0.15*HACET + 0.13*RCOOH + 0.08*CO2 + 0.6*HO2 + 0.35*MECO3-0.13*XC|3.94-15*exp<sup>(-1520/T)</sup>| | |
|<IS25>|ISOPND + OH = ISOPNOOD|1.20e-11*exp<sup>(652/T)</sup>| rate constant updated | Lee 2014 |
|<IS26>|ISOPNOOD + NO = 0.34*PRD2 + 0.15*PROPNN + 0.44*HACET + 0.07*MVKN + 0.13*ETHLN + 0.31*HCOOH + 0.31*NO3 + 0.72*HCHO + 0.15*HOCCHO + 1.34*NO2 + 0.35*HO2-0.68*XC|2.40e-12*exp<sup>(360/T)</sup>| rate constant updated | Lee 2014 |
|<IS141>|ISOPNOOD + HO2 = RNO3I-XC|2.06e-13*exp<sup>(1300/T)</sup>| | |
...
|<IS144>|ISOPNOOD + MECO3 = MEO2 + CO2 + 0.34*PRD2 + 0.15*PROPNN + 0.44*HACET + 0.07*MVKN + 0.13*ETHLN + 0.31*HCOOH + 0.31*NO3 + 0.72*HCHO + 0.15*HOCCHO + 0.34*NO2 + 0.35*HO2-0.68*XC|4.40e-13*exp<sup>(1070/T)</sup>| | |
...
|<IS28>|ISOPNB + OH = ISOPNOOB|2.4e-12*exp<sup>(745/T)</sup>|rate constant updated  | Lee 2014 |
|<IS29>|ISOPNOOB + NO = 0.6*HOCCHO + 0.6*HACET + 0.4*HCHO + 0.4*HO2 + 0.26*MACRN + 0.14*MVKN + 1.6*NO2|2.40e-12*exp<sup>(360/T)</sup>|rate constant updated | Lee 2014 |
|<IS145>|ISOPNOOB + HO2 = RNO3I-XC|2.06e-13*exp<sup>(1300/T)</sup>| | |
...
|<IS148>|ISOPNOOB + MECO3 = MEO2 + CO2 + 0.6*HOCCHO + 0.6*HACET + 0.4*HCHO + 0.4*HO2 + 0.26*MACRN + 0.14*MVKN + 0.6*NO2|4.40e-13*exp<sup>(1070/T)</sup>| | |
...
|<IS31>|NIT1 + NO3 = 0.6*NIT1NO3OOA + 0.6*HNO3 + 0.4*NIT1NO3OOB|3.15e-13*exp<sup>(-448/T)</sup>| | |
...
|<IS35>|NIT1NO3OOB + NO = 0.94*ISOPNN + 0.94*GLY + 0.94*NO2 + 0.06*RNO3I-0.06*XC + 0.13*XN|2.60e-12*exp<sup>(380/T)</sup>|PROPNN-->ISOPNN | modified by Pye 2015 |
|<IS37>|NIT1NO3OOB + HO2 = RNO3I-XC + XN|2.06e-13*exp<sup>(1300/T)</sup>| | |
...
|<IS44>|NIT1NO3OOB + MECO3 = MEO2 + CO2 + ISOPNN + GLY|4.40e-13*exp<sup>(1070/T)</sup>|PROPNN-->ISOPNN | modified by Pye 2015 |
|<IS46>|NIT1 + O3 = 0.3*PROPNN + 0.45*CO + 0.15*OH + 0.45*HO2 + 0.15*CO2 + 0.7*GLY + 0.7*OH + 0.7*NO2 + 0.7*MGLY|4.15e-15*exp<sup>(-1520/T)</sup>| PROPNNB-->PROPNN | Pye 2015 |
|<IS47>|NIT1 + OH = 0.345*NIT1NO3OOA + 0.655*NIT1OHOO|7.48e-12*exp<sup>(410/T)</sup>| | |
|<IS48>|NIT1OHOO + NO = 0.919*PROPNN + 0.919*GLY + 0.015*CO + 0.015*RNO3I + 0.934*NO2 + 0.934*HO2 + 0.066*RNO3I-0.096*XC + 0.066*XN|2.60e-12*exp<sup>(380/T)</sup>| PROPNNB-->PROPNN | Pye 2015 |
|<IS50>|NIT1OHOO + HO2 = R6OOH + XN-XC|2.06e-13*exp<sup>(1300/T)</sup>| | |
...
|<IS53>|NIT1OHOO + MECO3 = MEO2 + CO2 + 0.984*PROPNN + 0.984*GLY + 0.016*CO + 0.016*RNO3I + HO2-0.033*XC|4.40e-13*exp<sup>(1070/T)</sup>|PROPNNB-->PROPNN | Pye 2015 |
|<IS55>|DIBOO + NO = NO2 + HO2 + 0.52*HOCCHO + 0.52*MGLY + 0.48*GLY + 0.48*HACET|2.60e-12*exp<sup>(380/T)</sup>| | |
|<IS102>|DIBOO + HO2 = R6OOH-XC|2.06e-13*exp<sup>(1300/T)</sup>| | |
...
|<IS105>|DIBOO + MECO3 = HO2 + 0.52*HOCCHO + 0.52*MGLY + 0.48*GLY + 0.48*HACET + MEO2 + CO2|4.40e-13*exp<sup>(1070/T)</sup>| | |
|<IS56>|MVK + OH = MVKOO|2.60e-12*exp<sup>(610/T)</sup>| | |
|<IS57>|MVKOO + NO = 0.625*HOCCHO + 0.625*MECO3 + 0.265*MGLY + 0.265*HCHO + 0.265*HO2 + 0.11*MVKN + 0.89*NO2|2.60e-12*exp<sup>(380/T)</sup>| | |
|<IS58>|MVKOO + HO2 = ROOH + XC|1.82e-13*exp<sup>(1300/T)</sup>| | |
...
|<IS61>|MVKOO + MECO3 = MEO2 + CO2 + 0.7*HOCCHO + 0.7*MECO3 + 0.3*MGLY + 0.3*HCHO + 0.3*HO2|4.40e-13*exp<sup>(1070/T)</sup>| | |
|<IS63>|MACROO + NO = 0.85*NO2 + 0.85*HO2 + 0.72*HACET + 0.72*CO + 0.13*HCHO + 0.13*MGLY + 0.15*MACRN|2.60e-12*exp<sup>(380/T)</sup>| | |
|<IS64>|MACROO + HO2 = ROOH + XC|1.82e-13*exp<sup>(1300/T)</sup>| | |
...
|<IS67>|MACROO + MECO3 = MEO2 + CO2 + HO2 + 0.15*MGLY + 0.85*HACET + 0.85*CO + 0.15*HCHO|4.40e-13*exp<sup>(1070/T)</sup>| | |
|<IS69>|MACO3 + NO = NO2 + CO + CO2 + HCHO + MEO2|6.70e-12*exp<sup>(340/T)</sup>| | |
|<IS70>|MACO3 + HO2 = 0.3075*RCOOOH + 0.1025*RCOOH + 0.15*O3 + 0.44*OH + 0.44*HCHO + 0.44*MECO3 + 0.44*CO2|1.0*K<BR22>| revised acyl peroxy radical with HO2 by splitting organic into two parts | [http://iupac.pole-ether.fr/htdocs/datasheets/pdf/HOx_VOC54_HO2_CH3CO3.pdf IUPAC (2009)] |
...
|<IS80>|HACET + OH = 0.75*MGLY + 0.825*HO2 + 0.125*HCOOH + 0.1*OH + 0.125*MEO2 + 0.20*CO2 + 0.05*CO + 0.125*CCOOH|2.15e-12*exp<sup>(305/T)</sup>| | |
|<IS81>|HACET = HO2 + MECO3 + HCHO|1.75e-1/<MEK_06>| | |
|<IS82>|ETHLN + OH = HCHO + CO2 + NO2|2.94e-12*exp<sup>(365/T)</sup>| | |
...
|<IS84>|MVKN + OH = 0.65*HCOOH + 0.65*MGLY + 0.35*HCHO + 0.35*PYRUACD + NO3|3.50e-12*exp<sup>(140/T)</sup>| | |
|<IS106>|MVKN = MECO3 + NO2 + HOCCHO|1.0/<NOA>| | |
|<IS85>|MACRN + OH = 0.08*CCOOH + 0.08*HCHO + 0.08*NO3 + 0.07*HCOOH + 0.07*NO3 + 0.07*MGLY + 0.85*HACET + 0.85*NO2 + 0.93*CO2|1.28e-11*exp<sup>(405/T)</sup>| | |
...
|<IS89>|ISOPOOH + OH = 0.387*ISOPO2 + 0.613*HC5 + 0.613*OH|4.75e-12*exp<sup>(200/T)</sup>| | |
|<IS90>|IEPOX + OH = IEPOXOO|5.78e-11*exp<sup>(-400/T)</sup>| | |
|<IS91>|IEPOXOO + HO2 = 0.725*HACET + 0.275*HOCCHO + 0.275*GLY + 0.275*MGLY + 1.125*OH + 0.825*HO2 + 0.200*CO2 + 0.375*HCHO + 0.074*HCOOH + 0.251*CO|2.06e-13*exp<sup>(1300/T)</sup>| | |
|<IS96>|IEPOXOO + NO = 0.725*HACET + 0.275*HOCCHO + 0.275*GLY + 0.275*MGLY + 0.125*OH + 0.825*HO2 + 0.200*CO2 + 0.375*HCHO + 0.074*HCOOH + 0.251*CO + NO2|2.60e-12*exp<sup>(380/T)</sup>| | |
...
|<IS114>|IEPOXOO + MECO3 = 0.725*HACET + 0.275*HOCCHO + 0.275*GLY + 0.275*MGLY + 0.125*OH + 0.825*HO2 + 0.200*CO2 + 0.375*HCHO + 0.074*HCOOH + 0.251*CO + MEO2 + CO2|4.40e-13*exp<sup>(1070/T)</sup>| | |
...
|<IS139>|NISOPOOH + OH = 0.3*NISOPO2 + 0.7*OH + 0.7*NIT1|0.38e-11*exp<sup>(200/T)</sup>| | |
|<IS00>|MACR + OH = 0.53*MACROO + 0.47*IMACO3|8.00e-12*exp<sup>(380/T)</sup>|IMACO3 specifically from isoprene, yields adjusted | Crounse 2012, Lin 2013 |
|<BP56>|MACR + NO3 = 0.5*IMACO3 + 0.5*RO2C + 0.5*HNO3 + 0.5*xHO2 + 0.5*xCO + 0.5*yROOH + 1.5*XC + 0.5*XN|1.50e-12*exp<sup>(-1815/T)</sup>| | Lin 2013 |
...
|<IA69>|IMACO3 + NO = NO2 + CO + CO2 + HCHO + MEO2|6.70e-12*exp<sup>(340/T)</sup>| | Lin 2013 |
...
|<IA80>|MACROO = HACET + CO + OH|2.9e7*exp<sup>(-5297/T)</sup>| isomerization of MACR_OH-H addition (MACROO) species | Crounse 2012 |
|<IA51>|IMACO3 + NO2 = IMAPAN|1.0*K<BR28>| MPAN from isoprene tracked as IMAPAN | Lin 2013 |
|<IA52>|IMAPAN = IMACO3 + NO2|1.60e16*exp<sup>(-13486/T)</sup>| | Lin 2013 |
...
|<OLIG_ALK1|AALk<sub>1</sub>J = 1.7143*AOLGAJ|9.48816E-6| oligomerization reaction, product coefficient ensures carbon balance | Pye 2012 |
|<OLIG_ALK2|AALk<sub>2</sub>J = 1.7143*AOLGAJ|9.48816E-6| oligomerization reaction, product coefficient ensures carbon balance| Pye 2012 |
