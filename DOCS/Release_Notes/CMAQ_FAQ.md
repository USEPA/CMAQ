...
1. If running CMAQ with the STAGE option for dry deposition, the [STAGE O3 deposition to wet soil bugfix](CMAQv5.3.3_bugfixes.md#8-correct-o3-deposition-to-wet-soil-in-the-stage-deposition-option) will lead to slightly higher, typically less than 1ppb, ozone values primarily at night, early mornings and during precipitation events when both cuticular and soil surfaces are wet.
...
4. If running CMAQ with chemical mechanims cb6mp_ae6_aq, the [corrected control file](CMAQv5.3.2_bugfixes.md#1-correct-emission-control-file-for-cb6mp_ae6_aq-mechanism) leads to significant changes in concentration for a subset of Hazardous Air Pollutants (HAPs). Based on US continental simulations for 2017, the most affected HAPs are ethyl benzene (NMB = 21.0%), hexane (NMB = 17.0%), acrylic acid (NMB = 17.8%), and chloroprene (NMB = 4.4%), NMB, normalization mean bias is a domain average for July 2017.
