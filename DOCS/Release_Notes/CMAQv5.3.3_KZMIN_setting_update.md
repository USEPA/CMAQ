...
Routine CIO within CCTM was updated to not read PURB data from the GRID_CRO_2D meteorology file if the correct KZMIN setting was set. Instead, the PURB data is assumed to be 0.0 everywhere. 
