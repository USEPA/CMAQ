...
#> directory.
 ...
 set CMAQ_HOME = /home/bmurphy/cmaq_projects/pfas_github_20210125
...
#===============================================================================
 if ( $EXT_CCTM == 'Y' ) then
    ...
    cp CCTM/scripts/run_cctm_pfas_2018_1NC1.csh $CMAQ_HOME/CCTM/scripts/run_cctm_pfas_2018_1NC1.csh
