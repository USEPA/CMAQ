...
#> directory.
 set CMAQ_HOME = /proj/ie/proj/staff/lizadams/CMAQ_v52_DDM-3D/CMAQ_REPO/mvapich2_gcc4.8.1
...
#===============================================================================
 if ( $EXT_CCTM == 'Y' ) then
    ...
    cp CCTM/scripts/sensinput.cmas.dat $CMAQ_HOME/CCTM/scripts/sensinput.cmas.dat
 endif
